...
public class Servicesbygroup extends LiveStatusBase {
     ...
     */
    public Servicesbygroup(final String path) {
        super(path);
        this.initializeMaps();
    ...
    public String Servicegroup_action_url() {
        return this.getAsString("servicegroup_action_url");
    }
    ...
    public String Servicegroup_alias() {
        return this.getAsString("servicegroup_alias");
    }
    ...
    public String Servicegroup_members() {
        return this.getAsList("servicegroup_members");
    }
    ...
    public String Servicegroup_members_with_state() {
        return this.getAsList("servicegroup_members_with_state");
    }
    ...
    public String Servicegroup_name() {
        return this.getAsString("servicegroup_name");
    }
    ...
    public String Servicegroup_notes() {
        return this.getAsString("servicegroup_notes");
    }
    ...
    public String Servicegroup_notes_url() {
        return this.getAsString("servicegroup_notes_url");
    }
    ...
    public int Servicegroup_num_services() throws NumberFormatException {
        return this.getAsInt("servicegroup_num_services");
    }
    ...
    public int Servicegroup_num_services_crit() throws NumberFormatException {
        return this.getAsInt("servicegroup_num_services_crit");
    }
    ...
    public int Servicegroup_num_services_hard_crit() throws NumberFormatException {
        return this.getAsInt("servicegroup_num_services_hard_crit");
    }
    ...
    public int Servicegroup_num_services_hard_ok() throws NumberFormatException {
        return this.getAsInt("servicegroup_num_services_hard_ok");
    }
    ...
    public int Servicegroup_num_services_hard_unknown() throws NumberFormatException {
        return this.getAsInt("servicegroup_num_services_hard_unknown");
    }
    ...
    public int Servicegroup_num_services_hard_warn() throws NumberFormatException {
        return this.getAsInt("servicegroup_num_services_hard_warn");
    }
    ...
    public int Servicegroup_num_services_ok() throws NumberFormatException {
        return this.getAsInt("servicegroup_num_services_ok");
    }
    ...
    public int Servicegroup_num_services_pending() throws NumberFormatException {
        return this.getAsInt("servicegroup_num_services_pending");
    }
    ...
    public int Servicegroup_num_services_unknown() throws NumberFormatException {
        return this.getAsInt("servicegroup_num_services_unknown");
    }
    ...
    public int Servicegroup_num_services_warn() throws NumberFormatException {
        return this.getAsInt("servicegroup_num_services_warn");
    }
    ...
    public int Servicegroup_worst_service_state() throws NumberFormatException {
        return this.getAsInt("servicegroup_worst_service_state");
    }
    ...
    public Map<String, String> asArrayString(final String table, final String filter) throws NumberFormatException {
        ...
        this.addToHashtable("servicegroup_action_url", this.Servicegroup_action_url());
        this.addToHashtable("servicegroup_alias", this.Servicegroup_alias());
        this.addToHashtable("servicegroup_members", this.Servicegroup_members());
        this.addToHashtable("servicegroup_members_with_state", this.Servicegroup_members_with_state());
        this.addToHashtable("servicegroup_name", this.Servicegroup_name());
        this.addToHashtable("servicegroup_notes", this.Servicegroup_notes());
        this.addToHashtable("servicegroup_notes_url", this.Servicegroup_notes_url());
        this.addToHashtable("servicegroup_num_services", this.getAsString(this.Servicegroup_num_services()));
        this.addToHashtable("servicegroup_num_services_crit", this.getAsString(this.Servicegroup_num_services_crit()));
        this.addToHashtable("servicegroup_num_services_hard_crit", this.getAsString(this.Servicegroup_num_services_hard_crit()));
        this.addToHashtable("servicegroup_num_services_hard_ok", this.getAsString(this.Servicegroup_num_services_hard_ok()));
        this.addToHashtable("servicegroup_num_services_hard_unknown", this.getAsString(this.Servicegroup_num_services_hard_unknown()));
        this.addToHashtable("servicegroup_num_services_hard_warn", this.getAsString(this.Servicegroup_num_services_hard_warn()));
        this.addToHashtable("servicegroup_num_services_ok", this.getAsString(this.Servicegroup_num_services_ok()));
        this.addToHashtable("servicegroup_num_services_pending", this.getAsString(this.Servicegroup_num_services_pending()));
        this.addToHashtable("servicegroup_num_services_unknown", this.getAsString(this.Servicegroup_num_services_unknown()));
        this.addToHashtable("servicegroup_num_services_warn", this.getAsString(this.Servicegroup_num_services_warn()));
        this.addToHashtable("servicegroup_worst_service_state", this.getAsString(this.Servicegroup_worst_service_state()));
