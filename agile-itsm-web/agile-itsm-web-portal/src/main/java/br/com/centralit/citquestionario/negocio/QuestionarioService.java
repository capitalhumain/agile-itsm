...
public interface QuestionarioService extends CrudService {
    ...
    void copyGroup(final BaseEntity model) throws ServiceException, LogicException;

    QuestionarioDTO restoreByIdOrigem(final Integer idQuestionarioOrigem) throws Exception;

    void updateOrdemGrupos(final BaseEntity model) throws ServiceException, LogicException;

    void updateNomeGrupo(final BaseEntity model) throws ServiceException, LogicException;
