...
public class Enumerados implements Serializable {
     ...
     *
     * DATE_DEFAULT: dd/MM/yyyy ou MM/dd/yyyy, TIMESTAMP_DEFAULT: dd/MM/yyyy HH:mm ou MM/dd/yyyy HH:mm, TIMESTAMP_WITH_SECONDS: dd/MM/yyyy HH:mm:ss ou
     * MM/dd/yyyy HH:mm:ss, FORMAT_DATABASE: yyyy-MM-dd
     *
    ...
    public enum TipoDate {
        ...
        TipoDate(final String tipoDate) {
            tipoData = tipoDate;
        }
