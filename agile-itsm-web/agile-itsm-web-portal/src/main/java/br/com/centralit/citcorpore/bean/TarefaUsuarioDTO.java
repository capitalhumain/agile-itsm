...
public class TarefaUsuarioDTO extends SolicitacaoServicoDTO {
    ...
    /**
     * @param idElementoFluxo
     *            the idElementoFluxo to set
     */
    public void setIdElementoFluxo(final Integer idElementoFluxo) {
    ...
    /**
     * @param dataHoraCriacaoTarefa
     *            the dataHoraCriacaoTarefa to set
     */
    public void setDataHoraCriacaoTarefa(final Timestamp dataHoraCriacaoTarefa) {
    ...
    /**
     * @param dataHoraInicioTarefa
     *            the dataHoraInicioTarefa to set
     */
    public void setDataHoraInicioTarefa(final Timestamp dataHoraInicioTarefa) {
    ...
    /**
     * @param dataHoraFinalizacaoTarefa
     *            the dataHoraFinalizacaoTarefa to set
     */
    public void setDataHoraFinalizacaoTarefa(final Timestamp dataHoraFinalizacaoTarefa) {
    ...
    /**
     * @param dataHoraExecucaoTarefa
     *            the dataHoraExecucaoTarefa to set
     */
    public void setDataHoraExecucaoTarefa(final Timestamp dataHoraExecucaoTarefa) {
    ...
    /**
     * @param situacaoTarefa
     *            the situacaoTarefa to set
     */
    public void setSituacaoTarefa(final String situacaoTarefa) {
