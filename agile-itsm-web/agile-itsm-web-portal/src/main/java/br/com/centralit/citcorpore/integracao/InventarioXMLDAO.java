...
public class InventarioXMLDAO extends CrudDaoDefaultImpl {
     ...
     *             Excecao ganerica.
     */
    public boolean inventarioAtualizado(final String ip, final java.util.Date dataExpiracao) throws PersistenceException {
        final StringBuilder sql = new StringBuilder();
        final List<Date> parametro = new ArrayList<Date>();
