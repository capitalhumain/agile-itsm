...
public class EscalonamentoDAO extends CrudDaoDefaultImpl {
    ...
    public Collection findByRegraEscalonamento(final RegraEscalonamentoDTO regraEscalonamentoDTO) throws PersistenceException {
        final List campos = new ArrayList<>();
        ...
        if (list.isEmpty()) {
            ...
            return this.listConvertion(this.getBean(), list, campos);
        }
    }

    public void deleteByIdRegraEscalonamento(final Integer parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        condicao.add(new Condition("idRegraEscalonamento", "=", parm));
        super.deleteByCondition(condicao);
    }

    public void gravarDataFim(final Integer parm) throws PersistenceException {
