...
public class MonitoraIncidentes extends Thread {
    ...
    public void run() {
        while (true) {
            ...
            final TransactionControler tc = new TransactionControlerImpl(solicitacaoServicoDao.getAliasDB());
            try {
                if (!tc.isStarted()) {
                    tc.start();
                }
                        ...
                        if (ligaFuncionamentoRegrasEscalonamento != null && ligaFuncionamentoRegrasEscalonamento.equalsIgnoreCase("S")) {
                            ...
                            try {
                                ...
                                if (colecaoRegrasEscalonamento != null) {
                                    for (final RegraEscalonamentoDTO regraEscalonamentoDTO : colecaoRegrasEscalonamento) {
                                        ...
                                        this.trataSituacaoVencimentoSolicitacao(solicitacaoServicoDTO, regraEscalonamentoDTO, solicitacaoServicoDao,
                                                dataHoraAtual, ocorrSolDto, ID_MODELO_EMAIL_PRAZO_VENCENDO, tc);
                                        this.trataCriacaoAutomaticaDeProblema(solicitacaoServicoDTO, regraEscalonamentoDTO, solicitacaoServicoDao,
                                                dataHoraAtual, tc);
                                        ...
                                        if (colecaoEscalonamento != null) {
                                            for (final EscalonamentoDTO escalonamentoDTO : colecaoEscalonamento) {
                                                ...
                                                final boolean temEscalonamento = relEscalonamentoSolServicoDao.temRelacionamentoSolicitacaoEscalonamento(
                                                        solicitacaoServicoDTO.getIdSolicitacaoServico(), escalonamentoDTO.getIdEscalonamento());
                                                if (temEscalonamento) {
                                                ...
                                                if (regraEscalonamentoDTO.getTipoDataEscalonamento() != null
                                                    ...
                                                    if (solicitacaoServicoDTO.getDataHoraSolicitacao() != null
                                                            ...
                                                            && dataHoraAtual.getTime() - solicitacaoServicoDTO.getDataHoraSolicitacao().getTime() > escalonamentoDTO
                                                                    .getPrazoExecucao() * 60 * 1000) {
                                                        if (escalonamentoDTO.getIdGrupoExecutor() != null) {
                                                            /**
                                                             * Atualizando a tabela de relacionamento
                                                             */
                                                            final RelEscalonamentoSolServicoDto dto = new RelEscalonamentoSolServicoDto();
                                                            ...
                                                            /**
                                                             * Realizando o escalonamento da solicitação com base nas regras estabelecidas Se prioridade for
                                                             * nula estão se escalonamento com a mesma
                                                             * prioridade antiga
                                                             */
                                                            this.getSolicitacaoServicoService().updateTimeAction(
                                                             ...
                                                             */
                                                            this.enviaEmail(ID_MODELO_EMAIL_ESCALACAO_AUTOMATICA,
                                                                    solicitacaoServicoDTO.getIdSolicitacaoServico(), tc);

                                                            final List<AcordoNivelServicoDTO> listaContratos = acordoNivelServicoDao
                                                                    .findIdEmailByIdSolicitacaoServico(solicitacaoServicoDTO.getIdSolicitacaoServico());
                                                            if (listaContratos != null && !listaContratos.isEmpty()) {
                                                                this.enviaEmail(listaContratos.get(0).getIdEmail(),
                                                                        solicitacaoServicoDTO.getIdSolicitacaoServico(), tc);
                                                            }
                                                        }
                                                    }
                                                    ...
                                                    Date dateCons = null;
                                                    final OcorrenciaSolicitacaoDTO ocorrEscalacao = ocorrenciaSolicitacaoDao
                                                            .findUltimoByIdSolicitacaoServicoAndOcorrencia(solicitacaoServicoDTO.getIdSolicitacaoServico());
                                                        ...
                                                        try {
                                                            ...
                                                            if (dataHoraAtual.getTime() - timeAux.getTime() > escalonamentoDTO.getPrazoExecucao() * 60 * 1000) {
                                                                if (escalonamentoDTO.getIdGrupoExecutor() != null) {
                                                                    ...
                                                                    /**
                                                                     * Realizando o escalonamento da solicitação com base nas regras estabelecidas Se prioridade
                                                                     * for nula estão se escalonamento com a
                            ...
                            if (ocorrSolDto != null) {
                                ...
                                try {
                                    ...
                                    final Timestamp timeNow = UtilDatas.getDataHoraAtual();
                                    final long diffTempAux = UtilDatas.calculaDiferencaTempoEmMilisegundos(timeNow, timeAux);
                                    final double diffTemp = new Double(diffTempAux);
                                        ...
                                        if (solicitacaoServicoDTO.getIdGrupo1() != null || solicitacaoServicoDTO.getIdPrioridadeAuto1() != null) {
                                            if (solicitacaoServicoDTO.getIdPrioridadeAuto1() != null) {
                                                if (ocorrSolDto.getRegistradopor() != null && ocorrSolDto.getRegistradopor().trim().equalsIgnoreCase("AUTO")) {
                                                    if (solicitacaoServicoDTO.getIdPrioridadeAuto1().intValue() >= solicitacaoServicoDTO.getIdPrioridade()
                                                            .intValue()) {
                                            ...
                                            this.getSolicitacaoServicoService().updateTimeAction(solicitacaoServicoDTO.getIdGrupo1(),
                                                    solicitacaoServicoDTO.getIdPrioridadeAuto1(), solicitacaoServicoDTO.getIdSolicitacaoServico(), tc);
                                            try {
                                                this.enviaEmail(ID_MODELO_EMAIL_ESCALACAO_AUTOMATICA, solicitacaoServicoDTO.getIdSolicitacaoServico(), tc);
                                            } catch (final Exception e) {}
                                            ...
                                            try {
                                                ...
                                                final List<AcordoNivelServicoDTO> listaContratos = acordoNivelServicoDao
                                                        .findIdEmailByIdSolicitacaoServico(solicitacaoServicoDTO.getIdSolicitacaoServico());
                                                this.enviaEmail(listaContratos.get(0).getIdEmail(), solicitacaoServicoDTO.getIdSolicitacaoServico(), tc);
                                            } catch (final Exception e) {
    ...
    public void enviaEmail(final Integer idModeloEmail, final Integer idSolicitacaoServico, final TransactionControler tc) throws Exception {
        ...
        final SolicitacaoServicoDTO solicitacaoAuxDto = new SolicitacaoServicoServiceEjb().restoreAll(idSolicitacaoServico, tc);
        solicitacaoAuxDto.setNomeTarefa("Automatic escalation");

        final String idHashValidacao = CriptoUtils.generateHash("CODED" + solicitacaoAuxDto.getIdSolicitacaoServico(), "MD5");
        solicitacaoAuxDto.setHashPesquisaSatisfacao(idHashValidacao);
        solicitacaoAuxDto.setUrlSistema(urlSistema);
        solicitacaoAuxDto.setLinkPesquisaSatisfacao("<a href=\"" + urlSistema + "/pages/pesquisaSatisfacao/pesquisaSatisfacao.load?idSolicitacaoServico="
                + solicitacaoAuxDto.getIdSolicitacaoServico() + "&hash=" + idHashValidacao + "\">Clique aqui para fazer a avaliação do Atendimento</a>");
    ...
    public void enviaEmailGerente(final Integer idModeloEmail, final Integer idSolicitacaoServico, final TransactionControler tc) throws Exception {
        if (idModeloEmail == null || idModeloEmail.intValue() == 0) {
            return;
        }
    ...
    public boolean criaProblema(final SolicitacaoServicoDTO solicitacaoServicoDTO, final TransactionControler tc) throws Exception {

        final SolicitacaoServicoDao dao = new SolicitacaoServicoDao();
        dao.setTransactionControler(tc);
        ...
        // admin
        final UsuarioDTO usuarioDto = usuarioDao.restoreByIdEmpregado(1);
        final List<SolicitacaoServicoDTO> listIdSolicitacaoServico = new ArrayList<SolicitacaoServicoDTO>();
        ...
        problemaDto.setDescricao(StringEscapeUtils.escapeHtml4(solAux.getDescricaoSemFormatacao()));
    ...
    public void trataSituacaoVencimentoSolicitacao(final SolicitacaoServicoDTO solicitacaoServicoDTO, final RegraEscalonamentoDTO regraEscalonamentoDTO,
            final SolicitacaoServicoDao solicitacaoServicoDao, final Timestamp dataHoraAtual, final OcorrenciaSolicitacaoDTO ocorrSolDto,
            final Integer idModeloEmail, final TransactionControler tc) throws Exception {
        ...
        if (solicitacaoServicoDTO.getDataHoraLimite() != null && (solicitacaoServicoDTO.getPrazoHH() != 0 || solicitacaoServicoDTO.getPrazoMM() != 0)
                ...
                if (dataHoraAtual.getTime() - timeAux.getTime() > intervaloTempo) {
                    if (regraEscalonamentoDTO.getEnviarEmail() != null && regraEscalonamentoDTO.getEnviarEmail().equals("S")) {
                        ...
                        OcorrenciaSolicitacaoServiceEjb.create(solicitacaoServicoDTO, null, "Vencendo", OrigemOcorrencia.OUTROS,
                                CategoriaOcorrencia.Atualizacao, null, CategoriaOcorrencia.Atualizacao.getDescricao(), usuarioDTO, 0, null, tc);
                        if (idModeloEmail != null) {
                            this.enviaEmail(idModeloEmail, solicitacaoServicoDTO.getIdSolicitacaoServico(), tc);
                        }
                    }
                }
            }
            ...
            if (solicitacaoServicoDTO.getDataHoraLimite() != null && (solicitacaoServicoDTO.getPrazoHH() != 0 || solicitacaoServicoDTO.getPrazoMM() != 0)
                ...
                if (solicitacaoServicoDTO.getVencendo() != null && !solicitacaoServicoDTO.getVencendo().equalsIgnoreCase("S")) {
                    ...
                    if (idModeloEmail != null) {
                        this.enviaEmailGerente(idModeloEmail, solicitacaoServicoDTO.getIdSolicitacaoServico(), tc);
                    }
                    solicitacao = null;
    ...
    public void trataCriacaoAutomaticaDeProblema(final SolicitacaoServicoDTO solicitacaoServicoDTO, final RegraEscalonamentoDTO regraEscalonamentoDTO,
            final SolicitacaoServicoDao solicitacaoServicoDao, final Timestamp dataHoraAtual, final TransactionControler tc) throws Exception {
        if (regraEscalonamentoDTO.getPrazoCriarProblema() != null && regraEscalonamentoDTO.getCriaProblema() != null
                && regraEscalonamentoDTO.getCriaProblema().equalsIgnoreCase("S")) {
            if (dataHoraAtual.getTime() - solicitacaoServicoDTO.getDataHoraSolicitacao().getTime() >= regraEscalonamentoDTO.getPrazoCriarProblema() * 60 * 1000) {
                if (solicitacaoServicoDTO.getCriouProblemaAutomatico() == null) {
                    this.criaProblema(solicitacaoServicoDTO, tc);
                    SolicitacaoServicoDTO solicitacao = new SolicitacaoServicoDTO();
                    solicitacao.setIdSolicitacaoServico(solicitacaoServicoDTO.getIdSolicitacaoServico());
                    solicitacao = (SolicitacaoServicoDTO) solicitacaoServicoDao.restore(solicitacao);
