...
public class Util {
    ...
    public static byte[] gerarHash(final String frase, final String algoritmo) {
        try {
     ...
     * @throws Exception
     */
    public static StringBuilder createItemsCombo(final Collection col, final Class classe, String campoId, String campoDesc, final int valor) throws Exception {
     ...
     * @throws Exception
     */
    public static StringBuilder createItemsComboStrStr(final Collection col, final Class classe, String campoId, String campoDesc, final String valor) throws Exception {
        final StringBuilder retorno = new StringBuilder();
        final Iterator it = col.iterator();
    ...
    public static double getHoraDbl(final String hora) {
        if (hora == null) {
            return 0.0;
        }
    ...
    public static void verificaValorInexistente(final Object[] array, final int indice, final String msgErro) throws Exception {
