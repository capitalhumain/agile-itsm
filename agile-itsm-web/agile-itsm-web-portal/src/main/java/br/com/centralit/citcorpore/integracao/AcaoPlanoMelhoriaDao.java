...
public class AcaoPlanoMelhoriaDao extends CrudDaoDefaultImpl {
    ...
    @Override
    public Collection<AcaoPlanoMelhoriaDTO> find(final BaseEntity arg0) throws PersistenceException {
        return null;
    }
     ...
     * @author thays.araujo
     */
    public Collection<AcaoPlanoMelhoriaDTO> listAcaoPlanoMelhoria(final AcaoPlanoMelhoriaDTO acaoPlanoMelhoriaDto) throws PersistenceException {
        ...
        if (list != null && !list.isEmpty()) {
            final Collection<AcaoPlanoMelhoriaDTO> listAcaoPlanoMelhoria = this.listConvertion(AcaoPlanoMelhoriaDTO.class, list, listaRetorno);
    ...
    public void update(final BaseEntity obj) throws PersistenceException {
        final AcaoPlanoMelhoriaDTO acaoPlanoMelhoriaDTO = (br.com.centralit.citcorpore.bean.AcaoPlanoMelhoriaDTO) this.restore(obj);
