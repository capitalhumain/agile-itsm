...
public class RelatorioDocumentosAcessadosBaseConhecimentoDAO extends CrudDaoDefaultImpl {
    ...
    public Collection<RelatorioDocumentosAcessadosBaseConhecimentoDTO> listarDocumentosAcessadosBaseConhecimentoAnalitico(
            final RelatorioDocumentosAcessadosBaseConhecimentoDTO documentosAcessadosBaseConhecimentoDTO) {
        List result;
        try {
        ...
        return result == null || result.size() <= 0 ? new ArrayList<RelatorioDocumentosAcessadosBaseConhecimentoDTO>() : result;
    }
    ...
    public ArrayList<RelatorioDocumentosAcessadosBaseConhecimentoDTO> listarDocumentosAcessadosBaseConhecimentoResumido(
        ...
        try {
            ...
            if (relatorioDocumentosAcessadosBaseConhecimentoDTO.getIdUsuario() != null
                    && relatorioDocumentosAcessadosBaseConhecimentoDTO.getIdUsuario().intValue() > 0) {
                sql.append(" and idusuario = ? ");
            ...
            if (relatorioDocumentosAcessadosBaseConhecimentoDTO.getOrdenacao() != null
                    && relatorioDocumentosAcessadosBaseConhecimentoDTO.getOrdenacao().intValue() < 2) {
        ...
        return (ArrayList<RelatorioDocumentosAcessadosBaseConhecimentoDTO>) (result == null || result.size() <= 0 ? new ArrayList<RelatorioDocumentosAcessadosBaseConhecimentoDTO>()
                : result);
    }
