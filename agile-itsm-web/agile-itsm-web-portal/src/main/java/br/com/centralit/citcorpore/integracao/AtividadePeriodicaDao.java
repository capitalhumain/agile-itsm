...
public class AtividadePeriodicaDao extends CrudDaoDefaultImpl {
    ...
    public Collection findByIdProcedimentoTecnico(final Integer parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        final List<Order> ordenacao = new ArrayList<>();
    ...
    public void deleteByIdProcedimentoTecnico(final Integer parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        condicao.add(new Condition("idProcedimentoTecnico", "=", parm));
        super.deleteByCondition(condicao);
    }

    public Collection findByIdGrupoAtvPeriodica(final AgendaAtvPeriodicasDTO agendaAtvPeriodicasDTO) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        final List<Order> ordenacao = new ArrayList<>();
        ...
        // agendaAtvPeriodicasDTO.getIdGrupoAtvPeriodica() != 1) {
    ...
    public Collection<AtividadePeriodicaDTO> listSomenteReqMudanca(final AgendaAtvPeriodicasDTO agendaAtvPeriodicasDTO) throws PersistenceException {
        ...
        if (list != null && !list.isEmpty()) {
            final Collection<AtividadePeriodicaDTO> listaAgendaAtvPeriodica = this.listConvertion(AtividadePeriodicaDTO.class, list, listRetorno);
    ...
    public Collection<AtividadePeriodicaDTO> listAgendamentoVinculados(final AgendaAtvPeriodicasDTO agendaAtvPeriodicasDTO) throws PersistenceException {
    ...
    public Collection<AtividadePeriodicaDTO> listAgendamentoSemVinculacao(final AgendaAtvPeriodicasDTO agendaAtvPeriodicasDTO) throws PersistenceException {
    ...
    public void deleteByIdGrupoAtvPeriodica(final Integer parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        condicao.add(new Condition("idGrupoAtvPeriodica", "=", parm));
        super.deleteByCondition(condicao);
    }

    public Collection findByTituloAtividade(final Integer parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        final List<Order> ordenacao = new ArrayList<>();
    ...
    public void deleteByTituloAtividade(final Integer parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        condicao.add(new Condition("tituloAtividade", "=", parm));
        super.deleteByCondition(condicao);
    }
     ...
     * @throws Exception
     */
    public boolean existeDuplicacao(final String tituloAtividade, final Integer idAtividade) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        final List<Order> ordenacao = new ArrayList<>();
