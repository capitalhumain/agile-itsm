...
public class IPAddress {
    ...
    public IPAddress(String stringValue) {
        ...
        value = Integer.parseInt(parts[0], 10) << 8 * 3 & 0xFF000000 | Integer.parseInt(parts[1], 10) << 8 * 2 & 0x00FF0000
                | Integer.parseInt(parts[2], 10) << 8 * 1 & 0x0000FF00 | Integer.parseInt(parts[3], 10) << 8 * 0 & 0x000000FF;
    }
    ...
    public boolean nativePing() {
        ...
        try {
            final String command = isUnix ? "ping -c 4 -w 5" : "ping -4 -w 1250";
            process = Runtime.getRuntime().exec(command + " " + this.toString());
    ...
    public static void main(final String[] args) {
        ...
        final IPAddress ip2 = new IPAddress("10.255.255.255");
