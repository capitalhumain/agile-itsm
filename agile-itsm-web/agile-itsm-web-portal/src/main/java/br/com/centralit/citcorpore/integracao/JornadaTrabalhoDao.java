...
public class JornadaTrabalhoDao extends CrudDaoDefaultImpl {
     ...
     * @throws Exception
     */
    public boolean verificaJornadaExistente(final JornadaTrabalhoDTO jornadaTrabalho) throws PersistenceException {
        final List parametro = new ArrayList<>();
        List list = new ArrayList<>();
        String sql = "select idjornada from " + this.getTableName() + " where descricao = ? and dataFim is null ";
