...
public class CaracteristicaDTO extends BaseEntity {
    ...
    public CaracteristicaDTO(final String nome, final ValorDTO valor) {
        super();
        this.nome = nome;
        this.valor = valor;
    }
     ...
     * @param valor
     */
    public void setValor(final ValorDTO valor) {
        this.valor = valor;
    }
     ...
     * @param valorString
     */
    public void setValorString(final String valorString) {
    ...
    public boolean equals(final Object obj) {
        ...
        final CaracteristicaDTO other = (CaracteristicaDTO) obj;
        if (tag == null) {
            if (other.tag != null) {
                return false;
            }
