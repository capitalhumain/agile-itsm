...
public class ItemRequisicaoProdutoDao extends CrudDaoDefaultImpl {
    ...
    public Collection findTodosByIdSolicitacaoServico(final Integer parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        final List<Order> ordenacao = new ArrayList<>();
        condicao.add(new Condition("idSolicitacaoServico", "=", parm));
        ordenacao.add(new Order("idItemRequisicaoProduto"));
    ...
    public Collection findByIdSolicitacaoServicoAndSituacao(final Integer parm, final SituacaoItemRequisicaoProduto situacao) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        final List<Order> ordenacao = new ArrayList<>();
        condicao.add(new Condition("idSolicitacaoServico", "=", parm));
    ...
    public Collection findByIdSolicitacaoAndSituacaoAndTipoAtendimento(final Integer parm, final SituacaoItemRequisicaoProduto situacao,
            final String tipoAtendimento) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        final List<Order> ordenacao = new ArrayList<>();
        condicao.add(new Condition("idSolicitacaoServico", "=", parm));
        condicao.add(new Condition("situacao", "=", situacao.name()));
    ...
    public Collection findByIdProduto(final Integer parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        final List<Order> ordenacao = new ArrayList<>();
    ...
    public Collection findByIdItemCotacao(final Integer idItemCotacao) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        final List<Order> ordenacao = new ArrayList<>();
    ...
    public Collection findByIdItemCotacaoOrderQtde(final Integer idItemCotacao) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        final List<Order> ordenacao = new ArrayList<>();
        condicao.add(new Condition("idItemCotacao", "=", idItemCotacao));
    ...
    public Collection<ItemRequisicaoProdutoDTO> recuperaItensParaCotacao(final Date dataInicio, final Date dataFim, final Integer idCentroCusto,
            final Integer idProjeto, final Integer idEnderecoEntrega, final Integer idSolicitacaoServico) throws PersistenceException {
