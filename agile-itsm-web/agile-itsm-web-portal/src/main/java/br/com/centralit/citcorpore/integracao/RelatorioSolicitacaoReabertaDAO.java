...
public class RelatorioSolicitacaoReabertaDAO extends CrudDaoDefaultImpl {
    ...
    public ArrayList<RelatorioSolicitacaoReabertaDTO> listSolicitacaoReaberta(final RelatorioSolicitacaoReabertaDTO relatorioSolicitacaoReabertaDTO) {
        ...
        try {
             ...
             * @author thyen.chang
             */
            final boolean seLimita = relatorioSolicitacaoReabertaDTO.getTopList() != 0;
            ...
            if (relatorioSolicitacaoReabertaDTO.getDataInicialEncerramento() != null && relatorioSolicitacaoReabertaDTO.getDataFinalEncerramento() != null) {
                ...
                // para a data final de enconrramento foi necessario fazer este tratamento pois por exemplo, se a pesquisa é até o dia 10/02, buscava <=
                // 10/02/2014 00:00:00
                // ou seja se tivesse sido encerrada no dia 10/02/2014 as 00:01:00 não traria pois tava superior a 10/02/2014 00:00:00, portanto fora da faixa.
                // - Thiago Matias
                final Date dFinal = relatorioSolicitacaoReabertaDTO.getDataFinalEncerramento();
                long dFinal2;
    ...
    private Timestamp preparaHoraInicio(final Date dataI) throws ParseException {
        final java.sql.Date data = new java.sql.Date(dataI.getTime());
        final String dataHora = data + " 00:00:00";
    ...
    private Timestamp preparaHoraFim(final Date dataF) throws ParseException {
        final java.sql.Date data = new java.sql.Date(dataF.getTime());
