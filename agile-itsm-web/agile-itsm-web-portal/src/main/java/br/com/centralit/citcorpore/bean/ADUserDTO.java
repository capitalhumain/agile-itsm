...
public class ADUserDTO {
    ...
    /**
     * displayName = Guy Thomas. If you script this property, be sure you understand which field you are configuring. DisplayName can be confused with CN or
     * description.
     */
    ...
    /**
     * userPrincipalName = guyt@CP.com Often abbreviated to UPN, and looks like an email address. Very useful for logging on especially in a large Forest. Note
    ...
    /**
     * Legacy distinguished name for creating Contacts. In the following example, Guy Thomas is a Contact in the first administrative group of GUYDOMAIN:
     * /o=GUYDOMAIN/ou=first administrative
    ...
    public void setHomeDrive(final String homeDrive) {
    ...
    public void setObjectCategory(final String objectCategory) {
    ...
    public void setPhysicalDeliveryOfficeName(final String physicalDeliveryOfficeName) {
    ...
    public void setsAMAccountName(final String sAMAccountName) {
        if (sAMAccountName != null) {
    ...
    public void setHomeMDB(final String homeMDB) {
    ...
    public void setLegacyExchangeDN(final String legacyExchangeDN) {
    ...
    public void setmAPIRecipient(final String mAPIRecipient) {
    ...
    public void setLdapAtributo(final String ldapAtributo) {
