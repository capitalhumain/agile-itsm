...
public class PerfilAcessoDTO extends BaseEntity {
     ...
     */
    public void setNomePerfilAcesso(final String nomePerfilAcesso) {
     ...
     * @param acessoMenus
     */
    public void setAcessoMenus(final Collection<PerfilAcessoMenuDTO> acessoMenus) {
     ...
     */
    public void setAcessoMenuSerializados(final String acessoMenuSerializados) {
    ...
    /**
     * @param acessoSistemaCitsmart
     *            the acessoSistemaCitsmart to set
     */
    public void setAcessoSistemaCitsmart(final String acessoSistemaCitsmart) {
