...
public class ImagemItemConfiguracaoServiceEjb extends CrudServiceImpl implements ImagemItemConfiguracaoService {
    ...
    @Override
    public BaseEntity restore(final BaseEntity model) throws LogicException, ServiceException {
        return null;
    }
    ...
    @Override
    public void delete(final BaseEntity model) throws LogicException, ServiceException {
