...
public class ProblemaDAO extends CrudDaoDefaultImpl {
    ...
    public void delecaoLogica(final ProblemaDTO parm) throws Exception {
    ...
    public BaseEntity restore(final BaseEntity obj) throws PersistenceException {
        final ProblemaDTO problemaDto = (ProblemaDTO) obj;

        final List<Condition> condicao = new ArrayList<>();
        condicao.add(new Condition("dataHoraFim", "IS", null));
        condicao.add(new Condition("idProblema", "=", problemaDto.getIdProblema()));

        final ArrayList<ProblemaDTO> p = (ArrayList<ProblemaDTO>) super.findByCondition(condicao, null);
    ...
    public ProblemaDTO restoreAll(final Integer idProblema) throws Exception {
        ...
        if (lista != null && !lista.isEmpty()) {
            final List listaResult = engine.listConvertion(ProblemaDTO.class, lista, this.getColunasRestoreAll());
    ...
    public List<ProblemaDTO> listProblema(final ProblemaDTO bean) throws Exception {
        final List parametro = new ArrayList<>();
        ...
        String sql = "SELECT pro.idProblema, pro.titulo, con.numero, pro.datahoracaptura, us.nome, pro.idSolicitante, "
                ...
                + " FROM problema pro " + " LEFT OUTER JOIN usuario us on pro.idProprietario = us.idUsuario "
                + " LEFT OUTER JOIN servico serv on pro.idServico = serv.idServico " + " LEFT OUTER JOIN grupo grp on pro.idGrupo = grp.idGrupo "
                + " LEFT OUTER JOIN contratos con on con.idContrato = pro.idContrato " + " LEFT OUTER JOIN usuario us1 on pro.idSolicitante = us1.idEmpregado "
                + " LEFT OUTER JOIN servicocontrato sc ON sc.idservicocontrato = pro.idservicocontrato "
    ...
    public List<ProblemaDTO> listProblemaByIdSolicitacao(final ProblemaDTO bean) throws Exception {
        final List parametro = new ArrayList<>();
        final List fields = new ArrayList<>();
        List list = new ArrayList<>();
    ...
    @Override
    public Collection find(final BaseEntity problemaDTO) throws PersistenceException {
    ...
    public Collection<ProblemaDTO> findByIdProblemaPai(final Integer idProblemaPai) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
    ...
    public Collection findByStatus(final String parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        final List<Order> ordenacao = new ArrayList<>();
    ...
    public void deleteByStatus(final String parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        condicao.add(new Condition("status", "=", parm));
        super.deleteByCondition(condicao);
    }

    public Collection findByPrioridade(final Integer parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        final List<Order> ordenacao = new ArrayList<>();
    ...
    public void deleteByPrioridade(final Integer parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        condicao.add(new Condition("prioridade", "=", parm));
        super.deleteByCondition(condicao);
    }

    public Collection findByIdCriador(final Integer parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        final List<Order> ordenacao = new ArrayList<>();
    ...
    public void deleteByIdCriador(final Integer parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        condicao.add(new Condition("idCriador", "=", parm));
        super.deleteByCondition(condicao);
    }

    public Collection findByIdProprietario(final Integer parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        final List<Order> ordenacao = new ArrayList<>();
    ...
    public void deleteByIdProprietario(final Integer parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        condicao.add(new Condition("idProprietario", "=", parm));
        super.deleteByCondition(condicao);
    }

    public Collection findByTitulo(final String parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        final List<Order> ordenacao = new ArrayList<>();
    ...
    public void deleteByTitulo(final String parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        condicao.add(new Condition("titulo", "=", parm));
        super.deleteByCondition(condicao);
    }

    public Collection findByDescricao(final String parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        final List<Order> ordenacao = new ArrayList<>();
    ...
    public void deleteByDescricao(final String parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        condicao.add(new Condition("descricao", "=", parm));
        super.deleteByCondition(condicao);
    }
    ...
    public Collection findByImpacto(final String parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        final List<Order> ordenacao = new ArrayList<>();
    ...
    public void deleteByImpacto(final String parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        condicao.add(new Condition("impacto", "=", parm));
        super.deleteByCondition(condicao);
    }

    public Collection findByUrgencia(final String parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        final List<Order> ordenacao = new ArrayList<>();
    ...
    public void deleteByUrgencia(final String parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        condicao.add(new Condition("urgencia", "=", parm));
        super.deleteByCondition(condicao);
    }

    public Collection findByProativoReativo(final String parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        final List<Order> ordenacao = new ArrayList<>();
    ...
    public void deleteByProativoReativo(final String parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        condicao.add(new Condition("proativoReativo", "=", parm));
        super.deleteByCondition(condicao);
    }

    public Collection findByMsgErroAssociada(final String parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        final List<Order> ordenacao = new ArrayList<>();
    ...
    public void deleteByMsgErroAssociada(final String parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        condicao.add(new Condition("msgErroAssociada", "=", parm));
        super.deleteByCondition(condicao);
    }
    ...
    public Collection findByIdErrosConhecidos(final Integer parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        final List<Order> ordenacao = new ArrayList<>();
    ...
    public void deleteByIdErrosConhecidos(final Integer parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        condicao.add(new Condition("idErrosConhecidos", "=", parm));
        super.deleteByCondition(condicao);
    }
    ...
    public Collection findByIdProblemaIncidente(final Integer parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        final List<Order> ordenacao = new ArrayList<>();
    ...
    public void deleteByIdProblemaIncidente(final Integer parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        condicao.add(new Condition("idProblemaIncidente", "=", parm));
        super.deleteByCondition(condicao);
    }

    public List<ProblemaDTO> listProblemaByIdItemConfiguracao(final Integer idItemConfiguracao) throws Exception {
        final String sql = " Select pro.idProblema, pro.idsolicitante, pro.idproprietario, pro.titulo, pro.descricao, "
                + " pro.impacto, pro.urgencia, pro.proativoReativo, pro.severidade ,"
                + "emp.nome, us.nome "
                + " from problema pro "
                + " inner join problemaitemconfiguracao proitem on pro.idproblema = proitem.idproblema "
                ...
                + " inner join usuario us on us.idusuario = pro.idproprietario "
        ...
        return engine.listConvertion(ProblemaDTO.class, lista, listRetorno);
    }

    public Collection<ProblemaDTO> quantidadeProblemaPorBaseConhecimento(final ProblemaDTO problema) throws Exception {
        ...
        if (list != null && !list.isEmpty()) {
            final Collection<ProblemaDTO> listaQuantidadeProblemaPorBaseConhecimento = this.listConvertion(ProblemaDTO.class, list, listRetorno);
            return listaQuantidadeProblemaPorBaseConhecimento;
        }
        return null;
    }

    public Collection<ProblemaDTO> listaProblemasPorBaseConhecimento(final ProblemaDTO problema) throws Exception {
        ...
        if (list != null && !list.isEmpty()) {
            final Collection<ProblemaDTO> listaProblemaPorBaseConhecimento = this.listConvertion(ProblemaDTO.class, list, listRetorno);
     ...
     * @throws Exception
     */
    public List<ProblemaDTO> findByConhecimento(final BaseConhecimentoDTO baseConhecimentoDto) throws Exception {
        final List parametro = new ArrayList<>();
        final List fields = new ArrayList<>();
        List list = new ArrayList<>();
        final StringBuilder sql = new StringBuilder();
    ...
    public void atualizaDataHoraCaptura(final ProblemaDTO problemaDto) {
        final StringBuilder sql = new StringBuilder();
        sql.append("UPDATE " + this.getTableName() + " SET dataHoraCaptura = ? WHERE idproblema = ?");
        final Object[] params = {problemaDto.getDataHoraCaptura(), problemaDto.getIdProblema()};
        try {
    ...
    public Collection<ProblemaDTO> listByTarefas(final Collection<TarefaFluxoDTO> listTarefa) throws Exception {
    ...
    public ProblemaDTO restoreByIdInstanciaFluxo(final Integer idInstanciaFluxo) throws Exception {
        final List parametro = new ArrayList<>();
    ...
    public void updateFase(final Integer idProblema, final String fase) {
        final StringBuilder sql = new StringBuilder();
        sql.append("UPDATE " + this.getTableName() + " SET fase = ? WHERE (idProblema = ?)");
        final Object[] params = {fase, idProblema};
        try {
            this.execUpdate(sql.toString(), params);
        } catch (final PersistenceException e) {
    ...
    /**
     * Método responsável por efetuar a contagem de problemas com prazo (data e hora) limite de c,ontorno expirado. A contagem é feita por usuário proprietário
     * do problema. Caso existão um ou mais
     ...
     * @throws Exception
     */
    public int contarProblemasComPrazoLimiteContornoExpirado(final UsuarioDTO usuarioDTO) throws Exception {
        ...
        if (usuarioDTO != null && usuarioDTO.getIdUsuario() != null) {
            ...
            try {
                ...
                if (resultado != null && !resultado.isEmpty()) {
                    ...
                    final List colunas_retornadas = new ArrayList<>();
     ...
     * @author thays.araujo
     */
    public Collection<ProblemaDTO> listaProblemasComPrazoLimiteContornoExpirado(final UsuarioDTO usuarioDTO) throws Exception {
     ...
     * @throws Exception
     */
    public Collection<PesquisaProblemaDTO> listProblemaByCriterios(final PesquisaProblemaDTO pesquisaProblemaDto) throws Exception {
        ...
        if (CITCorporeUtil.SGBD_PRINCIPAL.toUpperCase().equals(SQLConfig.MYSQL) || CITCorporeUtil.SGBD_PRINCIPAL.toUpperCase().equals(SQLConfig.SQLSERVER)) {
            ...
            if (pesquisaProblemaDto.getDataInicio() != null) {
                ...
                sql.append(" where problema.datahorainicio BETWEEN TO_DATE('" + UtilDatas.dateToSTR(pesquisaProblemaDto.getDataInicio())
                        + "', 'DD/MM/YYYY ')  and TO_DATE('" + UtilDatas.dateToSTR(pesquisaProblemaDto.getDataFim()) + "', 'DD/MM/YYYY ') ");
        ...
        if (list != null && !list.isEmpty()) {
            ...
            final Collection<PesquisaProblemaDTO> listProblemaoMudancaByCriterios = this.listConvertion(PesquisaProblemaDTO.class, list, listRetorno);
    ...
    // if (list != null && !list.isEmpty()) {
    //
    // Collection<RelatorioProblemaIncidentesDTO> listProblemaoMudancaByCriterios = this.listConvertion(RelatorioProblemaIncidentesDTO.class, list,
    // listRetorno);
    //
    // return listProblemaoMudancaByCriterios;
    //
    ...
    //
    // }
    public Collection<RelatorioProblemaIncidentesDTO> listProblemaIncidentes(final RelatorioProblemaIncidentesDTO problemasIncidentes) throws Exception {
        ...
        if (CITCorporeUtil.SGBD_PRINCIPAL.toUpperCase().equals(SQLConfig.MYSQL) || CITCorporeUtil.SGBD_PRINCIPAL.toUpperCase().equals(SQLConfig.SQLSERVER)) {
            ...
            if (problemasIncidentes.getDataInicio() != null) {
                // Adaptação realizada passando o timestamp concatenado no
                // próprio sqp para poder colocar aspas simples na pesquisa
                sql.append(" where pr.datahorainicio BETWEEN TO_DATE('" + UtilDatas.dateToSTR(problemasIncidentes.getDataInicio())
                        + "', 'DD/MM/YYYY ')  and TO_DATE('" + UtilDatas.dateToSTR(problemasIncidentes.getDataFim()) + "', 'DD/MM/YYYY ') ");
            }
        }
        if (problemasIncidentes.getIdProblema() != null) {
            if (problemasIncidentes.getDataInicio() == null) {
        ...
        if (list != null && !list.isEmpty()) {
            ...
            final Collection<RelatorioProblemaIncidentesDTO> listProblemaoMudancaByCriterios = this.listConvertion(RelatorioProblemaIncidentesDTO.class, list,
                    listRetorno);
    ...
    public BaseEntity restoreTela(final BaseEntity obj) throws Exception {
        final ProblemaDTO problemaDto = (ProblemaDTO) obj;
    ...
    public BaseEntity restauraTodos(final BaseEntity obj) throws Exception {
        final ProblemaDTO problemaDto = (ProblemaDTO) obj;
     ...
     * @author thays.araujo
     */
    public Collection<RelatorioQuantitativoProblemaDTO> listaQuantidadeProblemaPorSituacao(
            final RelatorioQuantitativoProblemaDTO relatorioQuantitativoProblemaDto) throws Exception {
        final List listRetorno = new ArrayList<>();
        final List parametro = new ArrayList<>();
        ...
        sql.append("from " + this.getTableName() + " problema ");
        if (CITCorporeUtil.SGBD_PRINCIPAL.toUpperCase().equals(SQLConfig.ORACLE)) {
        ...
        if (CITCorporeUtil.SGBD_PRINCIPAL.toUpperCase().equals(SQLConfig.ORACLE)) {
            ...
            parametro.add(this.transformaHoraFinal(relatorioQuantitativoProblemaDto.getDataFim()));
        }
        ...
        if (lista != null && !lista.isEmpty()) {
            ...
            listaQuantidadeProblemaPorSituacao = engine.listConvertion(RelatorioQuantitativoProblemaDTO.class, lista, listRetorno);
     ...
     * @author thays.araujo
     */
    public Collection<RelatorioQuantitativoProblemaDTO> listaQuantidadeProblemaPorGrupo(final RelatorioQuantitativoProblemaDTO relatorioQuantitativoProblemaDto)
            throws Exception {
        final List listRetorno = new ArrayList<>();
        final List parametro = new ArrayList<>();
        ...
        if (lista != null && !lista.isEmpty()) {
            ...
            listaQuantidadeProblemaPorGrupo = engine.listConvertion(RelatorioQuantitativoProblemaDTO.class, lista, listRetorno);
     ...
     * @author thays.araujo
     */
    public Collection<RelatorioQuantitativoProblemaDTO> listaQuantidadeProblemaPorOrigem(final RelatorioQuantitativoProblemaDTO relatorioQuantitativoProblemaDto)
            throws Exception {
        final List listRetorno = new ArrayList<>();
        final List parametro = new ArrayList<>();
        ...
        if (lista != null && !lista.isEmpty()) {
            ...
            listaQuantidadeProblemaPorOrigem = engine.listConvertion(RelatorioQuantitativoProblemaDTO.class, lista, listRetorno);
     ...
     * @author thays.araujo
     */
    public Collection<RelatorioQuantitativoProblemaDTO> listaQuantidadeProblemaPorSolicitante(
            final RelatorioQuantitativoProblemaDTO relatorioQuantitativoProblemaDto) throws Exception {
        final List listRetorno = new ArrayList<>();
        final List parametro = new ArrayList<>();
        ...
        if (lista != null && !lista.isEmpty()) {
            ...
            listaQuantidadeProblemaPorSolicitante = engine.listConvertion(RelatorioQuantitativoProblemaDTO.class, lista, listRetorno);
     ...
     * @author thays.araujo
     */
    public Collection<RelatorioQuantitativoProblemaDTO> listaQuantidadeProblemaPorPrioridade(
            final RelatorioQuantitativoProblemaDTO relatorioQuantitativoProblemaDto) throws Exception {
        final List listRetorno = new ArrayList<>();
        final List parametro = new ArrayList<>();
        ...
        if (lista != null && !lista.isEmpty()) {
            ...
            listaQuantidadeProblemaPorPrioridade = engine.listConvertion(RelatorioQuantitativoProblemaDTO.class, lista, listRetorno);
     ...
     * @author thays.araujo
     */
    public Collection<RelatorioQuantitativoProblemaDTO> listaQuantidadeProblemaPorCategoria(
            final RelatorioQuantitativoProblemaDTO relatorioQuantitativoProblemaDto) throws Exception {
        final List listRetorno = new ArrayList<>();
        final List parametro = new ArrayList<>();
     ...
     * @author thays.araujo
     */
    public Collection<RelatorioQuantitativoProblemaDTO> listaQuantidadeProblemaPorProprietario(
            final RelatorioQuantitativoProblemaDTO relatorioQuantitativoProblemaDto) throws Exception {
        final List listRetorno = new ArrayList<>();
        final List parametro = new ArrayList<>();
        ...
        if (lista != null && !lista.isEmpty()) {
            ...
            listaQuantidadeProblemaPorProprietario = engine.listConvertion(RelatorioQuantitativoProblemaDTO.class, lista, listRetorno);
     ...
     * @author thays.araujo
     */
    public Collection<RelatorioQuantitativoProblemaDTO> listaQuantidadeProblemaPorImpacto(
            final RelatorioQuantitativoProblemaDTO relatorioQuantitativoProblemaDto) throws Exception {
        final List listRetorno = new ArrayList<>();
        final List parametro = new ArrayList<>();
        ...
        if (lista != null && !lista.isEmpty()) {
            ...
            listaQuantidadeProblemaPorImpacto = engine.listConvertion(RelatorioQuantitativoProblemaDTO.class, lista, listRetorno);
     ...
     * @author thays.araujo
     */
    public Collection<RelatorioQuantitativoProblemaDTO> listaQuantidadeProblemaPorUrgencia(
            final RelatorioQuantitativoProblemaDTO relatorioQuantitativoProblemaDto) throws Exception {
        final List listRetorno = new ArrayList<>();
        final List parametro = new ArrayList<>();
        ...
        if (lista != null && !lista.isEmpty()) {
            ...
            listaQuantidadeProblemaPorUrgencia = engine.listConvertion(RelatorioQuantitativoProblemaDTO.class, lista, listRetorno);
    ...
    public Collection listSolicitacoesByRegra() throws Exception {
        ...
        sql.append("SELECT distinct (s.idproblema), "
                ...
                + " regra4.idgrupo as idgrupo, s.vencendo, s.datahorainicio, s.prazohh, s.prazomm, s.impacto, s.urgencia  " + " FROM problema s   "
                + " INNER JOIN contratos contratos on contratos.idcontrato = s.idcontrato "
                + " INNER JOIN empregados solicitante on solicitante.idempregado = s.idsolicitante " + " LEFT JOIN grupo grupo on grupo.idgrupo = s.idgrupo "
