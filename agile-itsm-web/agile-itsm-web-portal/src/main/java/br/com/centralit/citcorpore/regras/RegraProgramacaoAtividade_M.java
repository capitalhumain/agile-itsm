...
public class RegraProgramacaoAtividade_M extends RegraProgramacaoAtividade {
    ...
    public java.util.Date calculaProximaExecucao(final ProgramacaoAtividadeDTO programacaoAtividadeDto, final java.util.Date dataRef) throws Exception {
        ...
        final java.util.Date dataExecucao = programacaoAtividadeDto.getProximaExecucao();
        ...
        if (dataExecucao == null || dataExecucao.compareTo(dataCalc) < 0) {
            final String[] meses = new String[] {"", programacaoAtividadeDto.getJan(), programacaoAtividadeDto.getFev(), programacaoAtividadeDto.getMar(),
                    programacaoAtividadeDto.getAbr(), programacaoAtividadeDto.getMai(), programacaoAtividadeDto.getJun(), programacaoAtividadeDto.getJul(),
                    programacaoAtividadeDto.getAgo(), programacaoAtividadeDto.getSet(), programacaoAtividadeDto.getOut(), programacaoAtividadeDto.getNov(),
                    programacaoAtividadeDto.getDez()};

            final int dia = UtilDatas.getDay(dataCalc);
            final int mes = UtilDatas.getMonth(dataCalc);
            int ano = UtilDatas.getYear(dataCalc);

            boolean bEncontrou = true;
            int diaExec = 0;
            int mesExec = mes;
            final int anoExec = ano;
            ...
            case 2:
                if (!meses[mes].equals("S")) {
                    ...
                    final Integer[] diasUteis = getDiasUteis(mesExec, anoExec);
            ...
            case 3:
                if (!meses[mes].equals("S")) {
                    ...
                    final HashMap<Integer, Integer[]> mapSemanas = getSemanas(mesExec, anoExec);
                    final Integer[] dias = mapSemanas.get(programacaoAtividadeDto.getDiaSemana().intValue());
    ...
    public void valida(final ProgramacaoAtividadeDTO programacaoAtividadeDto) throws Exception {
        ...
        if (programacaoAtividadeDto.getJan().equals("N") && programacaoAtividadeDto.getFev().equals("N") && programacaoAtividadeDto.getMar().equals("N")
                && programacaoAtividadeDto.getAbr().equals("N") && programacaoAtividadeDto.getMai().equals("N") && programacaoAtividadeDto.getJun().equals("N")
                && programacaoAtividadeDto.getJul().equals("N") && programacaoAtividadeDto.getAgo().equals("N") && programacaoAtividadeDto.getSet().equals("N")
                && programacaoAtividadeDto.getOut().equals("N") && programacaoAtividadeDto.getNov().equals("N") && programacaoAtividadeDto.getDez().equals("N")) {
    ...
    public String getDetalhamento(final ProgramacaoAtividadeDTO programacaoAtividadeDto) throws Exception {
        String descricao = "";
        final String[] seqDiaSemana = new String[] {"", "primeira(o)", "segunda(o)", "terceira(o)", "quarta(o)", "última(o)"};
        final String[] diaSemana = new String[] {"", "domingo", "segunda-feira", "terça-feira", "quarta-feira", "quinta-feira", "sexta-feira", "sábado"};
