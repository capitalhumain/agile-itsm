...
public class HistoricoMudancaDao extends CrudDaoDefaultImpl {
    ...
    public HistoricoMudancaDTO maxIdHistorico(final RequisicaoMudancaDTO requisicaoMudancaDTO) throws PersistenceException {
        final List parametro = new ArrayList<>();
        final List listRetorno = new ArrayList<>();
        final StringBuilder sql = new StringBuilder();

        sql.append("SELECT MAX(idHistoricoMudanca) AS idHistoricoMudanca FROM " + this.getTableName() + " WHERE idrequisicaomudanca = ?");
        ...
        final List result = this.listConvertion(HistoricoMudancaDTO.class, resultado, listRetorno);
    ...
    public List<HistoricoMudancaDTO> listHistoricoMudancaByIdRequisicaoMudanca(final Integer idRequisicaoMudanca) throws PersistenceException {
        final List listRetorno = new ArrayList<>();
        final List parametro = new ArrayList<>();
        final String sql = "SELECT HIST.REGISTROEXECUCAO, HIST.EMAILSOLICITANTE, HIST.ALTERARSITUACAO, HIST.ACAOFLUXO, HIST.IDHISTORICOMUDANCA, HIST.IDREQUISICAOMUDANCA, HIST.IDSOLICITANTE, "
        ...
        return this.listConvertion(HistoricoMudancaDTO.class, resultado, listRetorno);
    }
