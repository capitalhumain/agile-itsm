...
public class GenerateServiceRequisicoesProdPorUnidade extends GerencialGenerateService {
    ...
    public List execute(final HashMap parametersValues, final Collection paramtersDefinition) throws ParseException {
        ...
        try {
            final Collection<RequisicaoProdutoDTO> colRequisicoes = requisicaoDao.consultaRequisicoesPorUnidade(this.getNovoParametro());
            if (colRequisicoes != null) {
                for (final RequisicaoProdutoDTO requisicaoDto : colRequisicoes) {
                    ...
                    col.add(new Object[] {requisicaoDto.getNomeUnidadeSolicitante(), requisicaoDto.getIdSolicitacaoServico(),
                            requisicaoDto.getDataHoraSolicitacaoStr(), requisicaoDto.getContrato(), requisicaoDto.getCentroCusto(), requisicaoDto.getProjeto(),
                            requisicaoDto.getServico(), requisicaoDto.getDescrSituacao(), valor});
                }
            }
