...
public class OSDao extends CrudDaoDefaultImpl {
    ...
    public Collection findByIdContratoAndSituacao(final Integer parm, final Integer sit) throws PersistenceException {
    ...
    public Collection findByIdClassificacaoOS(final Integer parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        final List<Order> ordenacao = new ArrayList<>();
    ...
    public void deleteByIdClassificacaoOS(final Integer parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        condicao.add(new Condition("idClassificacaoOS", "=", parm));
        super.deleteByCondition(condicao);
    }

    public Collection findByAno(final Integer parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        final List<Order> ordenacao = new ArrayList<>();
    ...
    public Collection findByIdOsPai(final Integer idospai) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        final List<Order> ordenacao = new ArrayList<>();
    ...
    public void deleteByAno(final Integer parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        condicao.add(new Condition("ano", "=", parm));
        super.deleteByCondition(condicao);
    }

    public void updateSituacao(final Integer idOs, final Integer situacao) throws PersistenceException {
    ...
    public void updateObsFinal(final Integer idOs, final String obsFinal) throws PersistenceException {
        final OSDTO osDTO = new OSDTO();
        osDTO.setIdOS(idOs);
    ...
    public void updateQuantidade(final Integer idOs, final Integer quantidade) throws PersistenceException {
        final OSDTO osDTO = new OSDTO();
        osDTO.setIdOS(idOs);
    ...
    public void cancelaOSFilhas(final OSDTO os) throws PersistenceException {
        final Collection<OSDTO> resp = this.retornaSeExisteOSFilha(os.getIdOS());
        if (resp != null && resp.size() > 0) {
            for (final OSDTO osDto : resp) {
     ...
     * @throws Exception
     */
    public Collection retornaSeExisteOSFilha(final Integer idOSPai) throws PersistenceException {
        final List lstParametros = new ArrayList<>();
        final String sql = "SELECT * FROM " + this.getTableName() + " WHERE idospai = ? ";
        lstParametros.add(idOSPai);
        final List lstDados = super.execSQL(sql, lstParametros.toArray());
        final List fields = new ArrayList<>();
        fields.add("idOS");
        return super.listConvertion(OSDTO.class, lstDados, fields);
    }

    public Collection findByIdContratoAndPeriodoAndSituacao(final Integer idContrato, final Date dataInicio, final Date dataFim, final Integer[] situacao)
        ...
        if (situacao != null || dataInicio != null || dataFim != null) {
            ...
            if (situacao != null) {
                ...
                String strSqlAux = "";
                for (final Integer element : situacao) {
    ...
    public Collection findByIdContratoAndPeriodoAndSituacao(final Integer idContrato, final Date dataInicio, final Date dataFim, final Integer[] situacao,
            final Integer idosPai) throws PersistenceException {
        final List lstParametros = new ArrayList<>();
        String sql = "SELECT idOS, O.idServicoContrato, numero, ano, O.dataInicio, O.dataFim, demanda, O.objetivo, situacaoOS, nomeServico, quantidadeGlosasAnterior, quantidade, idOSPai, ";
        sql = sql + " (SELECT SUM(custoAtividade) FROM ATIVIDADESOS ATVOS WHERE ATVOS.idOS = O.idOS) AS custoOS, ";
        sql = sql + " (SELECT SUM(glosaAtividade) FROM ATIVIDADESOS ATVOS WHERE ATVOS.idOS = O.idOS) AS glosaOS ";
    ...
    public Collection listOSHomologadasENaoAssociadasFatura(final Integer idContrato) throws PersistenceException {
        final List lstParametros = new ArrayList<>();
        ...
        sql = sql
                + " idOS NOT IN (SELECT fos.idOs FROM faturaos fos JOIN fatura f ON f.idfatura = fos.idfatura WHERE f.situacaofatura <> ? AND fos.idos = idOs) AND O.situacaoOS = ? ";
        sql = sql + "ORDER BY O.dataInicio, O.dataFim, idOS ";
        lstParametros.add(idContrato);
    ...
    public Collection listOSAssociadasFatura(final Integer idFatura) throws PersistenceException {
        final List lstParametros = new ArrayList<>();
        String sql = "SELECT idOS, O.idServicoContrato, numero, ano, O.dataInicio, O.dataFim, demanda, O.objetivo, situacaoOS, nomeServico, ";
        sql = sql + " (SELECT SUM(custoAtividade) FROM ATIVIDADESOS ATVOS WHERE ATVOS.idOS = O.idOS) AS custoOS, ";
        sql = sql + " (SELECT SUM(glosaAtividade) FROM ATIVIDADESOS ATVOS WHERE ATVOS.idOS = O.idOS) AS glosaOS, ";
    ...
    public Collection listOSByIdAtividadePeriodica(final Integer idatividadeperiodica) throws PersistenceException {
        final String sql = "SELECT os.idOS, os.idcontrato, os.idclassificacaoos, os.idservicocontrato, os.ano, os.numero, "
    ...
    public Collection listAtividadePeridodicaByIdos(final Integer idos) throws PersistenceException {
        final String sql = "SELECT os.idOS, os.idcontrato, os.idclassificacaoos, os.idservicocontrato, os.ano, os.numero, "
    ...
    public Collection listOSByIds(final Integer idContrato, final Integer[] idOSs) throws PersistenceException {
        final List lstParametros = new ArrayList<>();
        String sql = "SELECT idOS, O.idServicoContrato, numero, ano, O.dataInicio, O.dataFim, demanda, O.objetivo, situacaoOS, nomeServico, ";
        sql = sql + " (SELECT SUM(custoAtividade) FROM ATIVIDADESOS ATVOS WHERE ATVOS.idOS = O.idOS) AS custoOS, ";
        sql = sql + " (SELECT SUM(glosaAtividade) FROM ATIVIDADESOS ATVOS WHERE ATVOS.idOS = O.idOS) AS glosaOS, ";
    ...
    public List<OSDTO> buscaOsEmCriacao() throws PersistenceException {
        ...
        final String sql = "SELECT idos FROM " + this.getTableName() + " WHERE situacaoos = ? ";

        final List respOs = super.execSQL(sql, parametros.toArray());

        final List fields = new ArrayList<>();
        fields.add("idOS");

        final List<OSDTO> listOs = super.listConvertion(OSDTO.class, respOs, fields);

        return listOs;

    }

    public Collection<RelatorioOrdemServicoUstDTO> listaCustoAtividadeOrdemServicoPorPeriodo(final RelatorioOrdemServicoUstDTO relatorio)
            throws PersistenceException {
        ...
        if (CITCorporeUtil.SGBD_PRINCIPAL.trim().equalsIgnoreCase(SQLConfig.ORACLE)
                || CITCorporeUtil.SGBD_PRINCIPAL.trim().equalsIgnoreCase(SQLConfig.POSTGRESQL)) {
        ...
        final List list = super.execSQL(sql.toString(), parametro.toArray());
        ...
        if (list != null && !list.isEmpty()) {
            final Collection<RelatorioOrdemServicoUstDTO> listaCustoAtividadePorPeriodo = this.listConvertion(RelatorioOrdemServicoUstDTO.class, list,
                    listaRetornor);
    ...
    public Collection<RelatorioOrdemServicoUstDTO> listaAnos() throws PersistenceException {
        ...
        final List list = super.execSQL(sql.toString(), null);
    ...
    public Collection<RelatorioAcompanhamentoDTO> listaAcompanhamentoPorPeriodoDoContrato(final RelatorioAcompanhamentoDTO relatorio)
            throws PersistenceException {
        final StringBuilder sql = new StringBuilder();
        final List parametro = new ArrayList<>();
        final List listaRetornor = new ArrayList<>();
        ...
        if (list != null && !list.isEmpty()) {
            final Collection<RelatorioAcompanhamentoDTO> listaAcompanhamentoPorPeriodoDoContrato = this.listConvertion(RelatorioAcompanhamentoDTO.class, list,
                    listaRetornor);
