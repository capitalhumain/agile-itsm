...
public class ConexaoBIDAO extends CrudDaoDefaultImpl {
     ...
     * @since 05.11.2013
     */
    public Integer totalDePaginas(final Integer itensPorPagina, final Collection<ConexaoBIDTO> listConexao, final ConexaoBIDTO conexaoBIDTO)
            throws PersistenceException {

        final StringBuilder sql = new StringBuilder();
        final List parametros = new ArrayList<>();
        /**
         * condição para verificar o total real de paginas quando for por meio do filtro, sem esta condição sempre estava trazendo o total geral de dados da
         * tabela
         */
     ...
     * @author euler.ramos
     */
    public ConexaoBIDTO findByIdProcessBatch(final Integer idProcessamentoBatch) throws PersistenceException {
        ...
        final String sql = "SELECT " + campos + " FROM " + this.getTableName()
                + " WHERE ((idprocessamentobatchespecifico = ?) or (idprocessamentobatchexcecao = ?))";
     ...
     * @throws Exception
     */
    public boolean jaExisteRegistroComMesmoNome(final ConexaoBIDTO conexaoBIDTO) throws PersistenceException {
     ...
     * @throws Exception
     */
    public boolean jaExisteRegistroComMesmoLink(final ConexaoBIDTO conexaoBIDTO) throws PersistenceException {
        final ArrayList<Condition> condicoes = new ArrayList<Condition>();
     ...
     * @throws Exception
     */
    public Collection<ConexaoBIDTO> listarConexoesPaginadas(final Collection<ConexaoBIDTO> conexaoBIDTO, Integer pgAtual, final Integer qtdPaginacao)
            throws PersistenceException {
        final List listRetorno = new ArrayList<>();
     ...
     * @throws Exception
     */
    public Collection<ConexaoBIDTO> listarConexoesPaginadasFiltradas(final ConexaoBIDTO conexaoBIDTO, Integer pgAtual, final Integer qtdPaginacao)
            throws PersistenceException {
        final List listRetorno = new ArrayList<>();
        listRetorno.add("idConexaoBI");
        listRetorno.add("nome");
    ...
    public Collection<ConexaoBIDTO> listarConexoesAtivas() {
        ...
        try {
            ...
            final String sql = "SELECT " + campos + " FROM " + this.getTableName() + " where status<>'I'";
     ...
     * @author euler.ramos
     */
    public boolean temAgendamentoAtivo(final ConexaoBIDTO conexaoBIDTO) throws ServiceException {
    ...
    public ArrayList<ConexaoBIDTO> listarConexoesAutomaticasSemAgendEspOuExcecao() throws ServiceException {
        final ArrayList<ConexaoBIDTO> result = new ArrayList<ConexaoBIDTO>();
        final ArrayList<ConexaoBIDTO> todasConexoes = (ArrayList<ConexaoBIDTO>) this.listarConexoesAtivas();
        for (final ConexaoBIDTO conexaoBIDTO : todasConexoes) {
    ...
    public Collection findByIdConexao(final ConexaoBIDTO conexaoBIDTO) throws PersistenceException {
