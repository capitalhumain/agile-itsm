...
public class TemplateImpressaoDao extends CrudDaoDefaultImpl {
    ...
    public Collection findByIdTipoTemplateImp(final Integer parm) throws PersistenceException {
    ...
    public void deleteByIdTipoTemplateImp(final Integer parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        condicao.add(new Condition("idTipoTemplateImp", "=", parm));
