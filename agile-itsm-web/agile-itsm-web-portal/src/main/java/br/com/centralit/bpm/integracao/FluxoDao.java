...
public class FluxoDao extends CrudDaoDefaultImpl {
    ...
    @Override
    public Collection<FluxoDTO> find(final BaseEntity obj) throws PersistenceException {
        return null;
    }
    ...
    private FluxoDTO recuperaEstrutura(final FluxoDTO fluxoDto) throws PersistenceException {
        ...
        final List<ElementoFluxoDTO> listPorta = new ArrayList<ElementoFluxoDTO>();
        final List<ElementoFluxoDTO> listEvento = new ArrayList<ElementoFluxoDTO>();
        final List<ElementoFluxoDTO> listFinalizacao = new ArrayList<ElementoFluxoDTO>();

        if (listElementoFluxoDto != null && !listElementoFluxoDto.isEmpty()) {

            for (final ElementoFluxoDTO elementoFluxoDto : listElementoFluxoDto) {

                final TipoElementoFluxo tipoElementoFluxo = TipoElementoFluxo.valueOf(elementoFluxoDto.getTipoElemento());
