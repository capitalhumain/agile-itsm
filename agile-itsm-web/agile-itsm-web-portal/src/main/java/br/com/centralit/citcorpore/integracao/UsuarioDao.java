...
public class UsuarioDao extends CrudDaoDefaultImpl {
    ...
    /**
     * Retorna de login que já existe
     *
     * @param obj
     * @return
     * @throws Exception
    ...
    /**
     * Restaura Usuário por nome do usuario.
     *
     * @param nomeUsuario
     * @return
     * @throws Exception
    ...
    public Long retornaQuantidadeUsuariosAtivos() throws PersistenceException {
        ...
        if (lista != null && !lista.isEmpty() && lista.get(0) != null) {
            // Pega o primeiro item da lista e converte para Array, depois pega a primeira posição que é o Long
