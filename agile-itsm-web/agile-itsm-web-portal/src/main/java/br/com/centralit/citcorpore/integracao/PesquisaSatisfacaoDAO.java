...
public class PesquisaSatisfacaoDAO extends CrudDaoDefaultImpl {
    ...
    public Collection<PesquisaSatisfacaoDTO> relatorioPesquisaSatisfacao(final PesquisaSatisfacaoDTO pesquisaSatisfacaoDTO) throws Exception {
        ...
        if (pesquisaSatisfacaoDTO.getDataInicio() != null && pesquisaSatisfacaoDTO.getDataFim() != null) {
            ...
            if (CITCorporeUtil.SGBD_PRINCIPAL.toUpperCase().equals(SQLConfig.ORACLE)) {
                ...
                parametro.add(this.transformaHoraFinal(pesquisaSatisfacaoDTO.getDataFim()));
            }
        }
        ...
        final List result = engine.listConvertion(PesquisaSatisfacaoDTO.class, lista, listRetorno);
        if (result != null) {
            return result;
        } else {
            return null;
    ...
    public PesquisaSatisfacaoDTO findByIdSolicitacaoServico(final Integer idSolicitacaoServico) throws Exception {
        ...
        if (list != null && !list.isEmpty()) {
            return (PesquisaSatisfacaoDTO) this.listConvertion(this.getBean(), list, fields).get(0);
        }
        return null;
    }
