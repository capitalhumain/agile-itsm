...
public class RedirectQuestionarioConfig {
    ...
    public RedirectQuestionarioConfig(final InputStream ioos, final String fileNameConfig) {
    ...
    public void setRedirectItens(final Collection redirectItens) {
        this.redirectItens = redirectItens;
    }

    public String getIncludeCorrespondente(final String aba, final String situacao) {
        final Collection colItens = this.getRedirectItens();
        if (colItens != null) {
            for (final Iterator it = colItens.iterator(); it.hasNext();) {
                final RedirectQuestionarioItem item = (RedirectQuestionarioItem) it.next();
