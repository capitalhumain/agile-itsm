...
public class ItemConfiguracaoDao extends CrudDaoDefaultImpl {
    ...
    public Collection findByIdItemConfiguracaoPai(final Integer parm) throws PersistenceException {
        final List parametro = new ArrayList<>();

        final StringBuilder sqlItemConfiguracao = new StringBuilder();

        sqlItemConfiguracao
        .append("SELECT itemConfiguracao.identificacao, itemConfiguracao.idItemConfiguracao, itemConfiguracao.status, tipoitemconfiguracao.imagem, itemConfiguracao.nome ");
        sqlItemConfiguracao
        .append("FROM ITEMCONFIGURACAO itemConfiguracao left join tipoitemconfiguracao on itemConfiguracao.idtipoitemconfiguracao = tipoitemconfiguracao.idtipoitemconfiguracao ");
        ...
        final List lista = this.execSQL(sqlItemConfiguracao.toString(), parametro.toArray());
        ...
        final Collection<ItemConfiguracaoDTO> result = engine.listConvertion(this.getBean(), lista, listRetorno);
        return result;
    }
    ...
    public void deleteByIdItemConfiguracaoPai(final Integer parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        condicao.add(new Condition("idItemConfiguracaoPai", "=", parm));
        super.deleteByCondition(condicao);
    }

    public Collection findByIdTipoItemConfiguracao(final String parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        final List<Order> ordenacao = new ArrayList<>();
    ...
    public void deleteByIdTipoItemConfiguracao(final Integer parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        condicao.add(new Condition("idTipoItemConfiguracao", "=", parm));
        super.deleteByCondition(condicao);
    }

    public Collection findByIdTipoItemConfiguracao(final Integer parm) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        final List<Order> ordenacao = new ArrayList<>();
    ...
    public void updateItemConfiguracaoFilho(final Integer idItemConfiguracao, final Date data, final Timestamp datahoradesinstalacao)
            throws PersistenceException {
        final List parametros = new ArrayList<>();

        new ItemConfiguracaoDTO();
        ...
        final String sql = "UPDATE " + this.getTableName() + " SET dataFim = ?, datahoradesinstalacao = ? WHERE idItemConfiguracaoPai = ? and dataFim is null";
        this.execUpdate(sql, parametros.toArray());
    }

    public Collection<ItemConfiguracaoDTO> listByIdentificacao(final PesquisaItemConfiguracaoDTO pesquisa) throws PersistenceException {
        final List parametro = new ArrayList<>();
        ...
        if (pesquisa.getDesinstalacao() != null && pesquisa.getInstalacao() != null) {
            sqlItemConfiguracao
            .append("and (itemconfiguracaoevento.tipoexecucao = ? or itemconfiguracaoevento.tipoexecucao = ? or itemconfiguracaoevento.tipoexecucao is null) ");
            parametro.add(pesquisa.getDesinstalacao());
            parametro.add(pesquisa.getInstalacao());
        }
    ...
    public Collection<ItemConfiguracaoDTO> listByIdentificacaoNaoDesativados(final PesquisaItemConfiguracaoDTO pesquisa) throws PersistenceException {
        final List parametro = new ArrayList<>();
    ...
    public Collection<ItemConfiguracaoDTO> pesquisaDataExpiracao(final java.util.Date data) throws PersistenceException {
        final List parametro = new ArrayList<>();
        ...
        final List result = engine.listConvertion(ItemConfiguracaoDTO.class, lista, listRetorno);

        return result;
    }

    public InformacaoItemConfiguracaoDTO listByInformacao(final ItemConfiguracaoDTO itemConfiguracao) throws PersistenceException {
        final List parametro = new ArrayList<>();
        ...
        final List result = engine.listConvertion(InformacaoItemConfiguracaoDTO.class, lista, listRetorno);
        return (InformacaoItemConfiguracaoDTO) result.get(0);
    }

    public Collection<ItemConfiguracaoDTO> listItemConfiguracaoFilho(final ItemConfiguracaoDTO itemConfiguracao) throws PersistenceException {
        final List parametro = new ArrayList<>();

        final StringBuilder sb = new StringBuilder();

        sb.append("SELECT idItemConfiguracao, idTipoItemConfiguracao ");
        sb.append("FROM " + this.getTableName() + " itemConfiguracao ");
    ...
    public ItemConfiguracaoDTO listIdUsuario(final String obj) throws PersistenceException {
        final List parametro = new ArrayList<>();
        final List fields = new ArrayList<>();
        List list = new ArrayList<>();
        final String sql = "select idusuario from Usuario where Login  = ? ";
        parametro.add(obj);
        list = this.execSQL(sql, parametro.toArray());
        if (list.isEmpty()) {
            return null;
        } else {
            return (ItemConfiguracaoDTO) this.listConvertion(this.getBean(), list, fields).get(0);
     ...
     *             Excecao generica.
     */
    public Collection<ItemConfiguracaoDTO> listByGrupo(final GrupoItemConfiguracaoDTO grupoICDto, final String criticidade, final String status)
            throws PersistenceException {
        final List parametro = new ArrayList<>();
     ...
     *             Excecao generica.
     */
    public Collection<ItemConfiguracaoDTO> listByGrupo(final GrupoItemConfiguracaoDTO grupoICDto, final ItemConfiguracaoDTO itemConfiguracaoDTO)
            throws PersistenceException {
        final List parametro = new ArrayList<>();
     ...
     *             Excecao generica.
     */
    public Collection<ItemConfiguracaoDTO> listItensSemGrupo(final String criticidade, final String status) throws PersistenceException {
        final List parametro = new ArrayList<>();
     ...
     *             Excecao generica.
     */
    public Collection<ItemConfiguracaoDTO> listItensSemGrupo(final String criticidade, final String status, final String sistemaOperacional,
            final String grupoTrabalho, final String tipoMembroDominio, final String usuario, final String processador, final List softwares)
                    throws PersistenceException {
        final List parametro = new ArrayList<>();
        ...
        if (sistemaOperacional != null && !sistemaOperacional.equals("")) {
            final String itemStr = sistemaOperacional.replaceAll("'", "");
        ...
        if (grupoTrabalho != null && !grupoTrabalho.equals("")) {
            final String itemStr = grupoTrabalho.replaceAll("'", "");
            sqlItemConfiguracao.append(" AND itemConfiguracao.iditemconfiguracao IN ");
            sqlItemConfiguracao.append("(");
            sqlItemConfiguracao.append("SELECT itemConfiguracaoAux.IDITEMCONFIGURACAOPAI FROM ITEMCONFIGURACAO itemConfiguracaoAux ");
            sqlItemConfiguracao.append("WHERE itemConfiguracaoAux.DATAFIM IS NULL ");
        ...
        if (tipoMembroDominio != null && !tipoMembroDominio.equals("")) {
            final String itemStr = tipoMembroDominio.replaceAll("'", "");
            sqlItemConfiguracao.append(" AND itemConfiguracao.iditemconfiguracao IN ");
            sqlItemConfiguracao.append("(");
            sqlItemConfiguracao.append("SELECT itemConfiguracaoAux.IDITEMCONFIGURACAOPAI FROM ITEMCONFIGURACAO itemConfiguracaoAux ");
            sqlItemConfiguracao.append("WHERE itemConfiguracaoAux.DATAFIM IS NULL ");
        ...
        if (usuario != null && !usuario.equals("")) {
            final String itemStr = usuario.replaceAll("'", "");
            sqlItemConfiguracao.append(" AND itemConfiguracao.iditemconfiguracao IN ");
            sqlItemConfiguracao.append("(");
            sqlItemConfiguracao.append("SELECT itemConfiguracaoAux.IDITEMCONFIGURACAOPAI FROM ITEMCONFIGURACAO itemConfiguracaoAux ");
            sqlItemConfiguracao.append("WHERE itemConfiguracaoAux.DATAFIM IS NULL ");
        ...
        if (softwares != null && softwares.size() > 0) {
            ...
            for (final Iterator it = softwares.iterator(); it.hasNext();) {
                final String soft = (String) it.next();
                if (soft != null && !soft.trim().equalsIgnoreCase("")) {
                    final String itemStr = soft.replaceAll("'", "");
                    sqlItemConfiguracao.append(" AND itemConfiguracao.iditemconfiguracao IN ");
                    sqlItemConfiguracao.append("(");
                    sqlItemConfiguracao.append("SELECT itemConfiguracaoAux.IDITEMCONFIGURACAOPAI FROM ITEMCONFIGURACAO itemConfiguracaoAux ");
                    sqlItemConfiguracao.append("WHERE itemConfiguracaoAux.DATAFIM IS NULL ");
     ...
     *             Excecao generica.
     */
    public Collection<ItemConfiguracaoDTO> listItensSemGrupo(final ItemConfiguracaoDTO itemConfiguracaoDTO) throws PersistenceException {
        final List parametro = new ArrayList<>();
    ...
    public void atualizaGrupo(final ItemConfiguracaoDTO itemConfiguracaoDTO) throws PersistenceException {
        final List parametros = new ArrayList<>();
        final StringBuilder sqlItemConfiguracao = new StringBuilder();
        ...
        sqlItemConfiguracao.append("UPDATE " + this.getTableName() + " SET idGrupoItemConfiguracao = ? WHERE idItemConfiguracao = ?");

        this.execUpdate(sqlItemConfiguracao.toString(), parametros.toArray());
    }
     ...
     * @throws Exception
     */
    public Collection<ItemConfiguracaoDTO> listByEvento(final Integer idEvento) throws PersistenceException {
        final String sql = "SELECT ic.iditemconfiguracao, ic.identificacao, ic.nome FROM " + this.getTableName()
     ...
     * @throws Exception
     */
    public boolean verificaMidiaSoftware(final Integer idMidiaSoftware) throws PersistenceException {
        boolean exists;
        final List parametro = new ArrayList<>();
        List list = new ArrayList<>();
        final StringBuilder sql = new StringBuilder();
        sql.append("select idItemConfiguracao from " + this.getTableName() + " where idMidiaSoftware = ? and datafim is null  ");
     ...
     * @throws Exception
     */
    public Integer quantidadeMidiaSoftware(final ItemConfiguracaoDTO itemDTO) throws PersistenceException {
        final List parametro = new ArrayList<>();
        List list = new ArrayList<>();
        final StringBuilder sql = new StringBuilder();
        ...
        if (itemDTO.getIdItemConfiguracao() != null) {
            sql.append(" and itemconfiguracao.iditemconfiguracao not in (select idItemConfiguracao from " + this.getTableName()
     ...
     * @throws Exception
     */
    public boolean VerificaSeCadastrado(final ItemConfiguracaoDTO itemDTO) throws PersistenceException {
        ...
        final StringBuilder sql = new StringBuilder();
        sql.append("select idItemConfiguracao from " + this.getTableName() + " where ( LOWER(identificacao) =  LOWER(?) ");
    ...
    /**
     * Verifica duplicidade de um item de configuração com o mesmo nome e se o item retornado na lista não é o próprio item que está sendo consultado para
     * permitir alteração. Caso exista retorna TRUE.
     * Caso não exista retorna FALSE;
     *
     * @author cleziomar.egidio 25/11/2014
     */
    public boolean validaDuplicidadeItemConfiguracao(final ItemConfiguracaoDTO bean) throws PersistenceException {
        final List<Condition> condicao = new ArrayList<>();
        List result = null;
        if (bean != null) {
        ...
        if (result != null && result.size() > 0) {
            if (result.size() == 1) {
                try {
                    final ItemConfiguracaoDTO itemCorrente = (ItemConfiguracaoDTO) result.get(0);
    ...
    // bruno.aquino
    public Collection listItemConfiguracaoPorSolicitacaoServicoEmAndamento(final int idSolicitante, final String situacao, final String idservico)
            throws PersistenceException {
        ...
        fields.add("idItemConfiguracao");
        return this.listConvertion(SolicitacaoServicoDTO.class, resultado, fields);
    }

    public Collection<ItemConfiguracaoDTO> listItemConfiguracaoByIdMudanca(final Integer idMudanca) throws PersistenceException {
        final String sql = "SELECT ic.identificacao, ic.familia, ic.classe, ic.localidade FROM " + this.getTableName()
        ...
        final List<?> dados = this.execSQL(sql, new Object[] {idMudanca});
        final List<String> fields = new ArrayList<String>();
        fields.add("identificacao");
        fields.add("familia");
        fields.add("classe");
    ...
    public Collection<ItemConfiguracaoDTO> listItemConfiguracaoByIdProblema(final Integer problema) throws PersistenceException {
        final String sql = "SELECT ic.identificacao, ic.familia, ic.classe, ic.localidade FROM " + this.getTableName()
        ...
        final List<?> dados = this.execSQL(sql, new Object[] {problema});
        final List<String> fields = new ArrayList<String>();
        fields.add("identificacao");
        fields.add("familia");
        fields.add("classe");
    ...
    public Collection<ItemConfiguracaoDTO> listItemConfiguracaoByIdIncidente(final Integer idIncidente) throws PersistenceException {
        final String sql = "SELECT ic.identificacao, ic.familia, ic.classe, ic.localidade FROM " + this.getTableName()
        ...
        final List<?> dados = this.execSQL(sql, new Object[] {idIncidente});
        final List<String> fields = new ArrayList<String>();
        fields.add("identificacao");
        fields.add("familia");
        fields.add("classe");
    ...
    public Collection<ItemConfiguracaoDTO> quantidadeItemConfiguracaoPorBaseConhecimento(final ItemConfiguracaoDTO itemConfiguracao)
            throws PersistenceException {
        ...
        if (list != null && !list.isEmpty()) {
            final Collection<ItemConfiguracaoDTO> listaQuantidadeItemConfiguracaoPorBaseConhecimento = this.listConvertion(ItemConfiguracaoDTO.class, list,
                    listRetorno);
    ...
    public Collection<ItemConfiguracaoDTO> listaItemConfiguracaoPorBaseConhecimento(final ItemConfiguracaoDTO itemConfiguracao) throws PersistenceException {
        ...
        if (list != null && !list.isEmpty()) {
            final Collection<ItemConfiguracaoDTO> listaItemConfiguracaoPorBaseConhecimento = this.listConvertion(ItemConfiguracaoDTO.class, list, listRetorno);
     ...
     */
    public List<ItemConfiguracaoDTO> findByConhecimento(final BaseConhecimentoDTO baseConhecimentoDto) throws PersistenceException {
        final List parametro = new ArrayList<>();
        final List listRetorno = new ArrayList<>();
        List list = new ArrayList<>();
        final StringBuilder sql = new StringBuilder();
     ...
     * @throws Exception
     */
    public List<ItemConfiguracaoDTO> listaItemConfiguracaoOfficePak(final ItemConfiguracaoDTO itemConfiguracaoDTO) throws PersistenceException {
        final List parametro = new ArrayList<>();
        final List listRetorno = new ArrayList<>();
        List list = new ArrayList<>();
        final StringBuilder sql = new StringBuilder();
        ...
        if (itemConfiguracaoDTO.getMidiaSoftwareChaves() != null) {
            ...
            boolean flag = false;
            for (final MidiaSoftwareChaveDTO object : itemConfiguracaoDTO.getMidiaSoftwareChaves()) {
                if (!flag) {
     ...
     * @throws Exception
     */
    public List<ItemConfiguracaoDTO> listaItemConfiguracaoOfficePak(final ItemConfiguracaoDTO itemConfiguracaoDTO, final String chave)
            throws PersistenceException {
        final List parametro = new ArrayList<>();
        final List listRetorno = new ArrayList<>();
        List list = new ArrayList<>();
    ...
    public boolean atualizaIdGrupoPadrao(final ItemConfiguracaoDTO ic, final int id) {
        final String sql = "update " + this.getTableName() + " set idGrupoItemConfiguracao = ? where idItemConfiguracao = ? ";
        final Object[] parametros = {id, ic.getIdItemConfiguracao()};
        try {
    ...
    public Collection<ItemConfiguracaoDTO> listItemConfiguracaoByIdLiberacao(final Integer idLiberacao) throws PersistenceException {
        final String sql = "SELECT ic.identificacao, ic.familia, ic.classe, ic.localidade FROM " + this.getTableName()
        ...
        final List<?> dados = this.execSQL(sql, new Object[] {idLiberacao});
        final List<String> fields = new ArrayList<String>();
        fields.add("identificacao");
        fields.add("familia");
        fields.add("classe");
    ...
    public boolean atualizaStatus(final Integer item, final Integer status) {
        final String sql = "update " + this.getTableName() + " set status = ? where idItemConfiguracao = ? ";
        final Object[] parametros = {status, item};
        try {
            this.execUpdate(sql, parametros);
            return true;
        } catch (final PersistenceException e) {
     ...
     * @author maycon.silva
     */
    public void finalizarItemConfiguracao(final ItemConfiguracaoDTO itemConfiguracaoDTO) {
        try {
            this.updateNotNull(itemConfiguracaoDTO);
        } catch (final Exception e) {
    ...
    public List<ItemConfiguracaoDTO> listItemConfiguracaoFinalizadosByIdItemconfiguracao(final ItemConfiguracaoDTO itemConfiguracaoDto)
            throws PersistenceException {
        final List parametro = new ArrayList<>();
        ...
        final List dados = this.execSQL(sql, parametro.toArray());

        return this.listConvertion(this.getBean(), dados, this.getField());
    }

    public ItemConfiguracaoDTO findByIdentificacaoItemConfiguracao(final ItemConfiguracaoDTO itemConfiguracaoDTO) throws PersistenceException {
        final List parametro = new ArrayList<>();
        ...
        if (lista != null && !lista.isEmpty()) {
            return (ItemConfiguracaoDTO) engine.listConvertion(this.getBean(), lista, listRetorno).get(0);
        } else {
            return null;
        }
    }
    ...
    public Collection<ItemConfiguracaoDTO> listByIdGrupoAndTipoItemAndIdItemPaiAtivos(final Integer idGrupo, final Integer idTipo, final Integer idPai)
            throws PersistenceException {
        final List parametro = new ArrayList<>();
    ...
    public Collection<ItemConfiguracaoDTO> listByIdItemPaiAndTagTipoItemCfg(final Integer idItemConfiguracaoPai, final String tagTipoCfg)
            throws PersistenceException {
        final String sql = "SELECT " + this.getNamesFieldsStr() + " " + "FROM itemconfiguracao where iditemconfiguracaopai = ? AND idtipoitemconfiguracao IN "
                + "(SELECT idtipoitemconfiguracao FROM tipoitemconfiguracao where tagtipoitemconfiguracao = ?) " + "AND datafim IS NULL";
        final List<?> dados = this.execSQL(sql, new Object[] {idItemConfiguracaoPai, tagTipoCfg});
        final List<String> fields = this.getListNamesFieldClass();
        return this.listConvertion(this.getBean(), dados, fields);
    }

    public ItemConfiguracaoDTO findByIdItemConfiguracaoWithIdentificacaoPai(final Integer idItemConfiguracao) throws PersistenceException {
        final StringBuilder sql = new StringBuilder();
        final List parametros = new ArrayList<>();
        final List listRetorno = new ArrayList<>();
        ...
        final List result = engine.listConvertion(ItemConfiguracaoDTO.class, retorno, listRetorno);
