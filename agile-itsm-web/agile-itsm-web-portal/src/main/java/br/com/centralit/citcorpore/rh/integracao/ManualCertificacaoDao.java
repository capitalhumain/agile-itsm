...
public class ManualCertificacaoDao extends CrudDaoDefaultImpl {

    public ManualCertificacaoDao() {
    ...
    public Collection<Field> getFields() {
        ...
        listFields.add(new Field("idManualCertificacao", "idManualCertificacao", true, true, false, false));
    ...
    public String getTableName() {
        return "rh_manualCertificacao";
    }

    @Override
    public Class getBean() {
        return ManualCertificacaoDto.class;
    }
    ...
    public Collection findByNome(String nome) throws PersistenceException {
        ...
        sql.append("select  c.idManualCertificacao, c.descricao, c.detalhe, c.idManualFuncao, c.RAouRF ");
        sql.append(" from rh_manualCertificacao c ");
        ...
        listRetorno.add("idManualCertificacao");
