...
/**
 * Class Downtimes is the main class for obtain all columns of table "downtimes"
 * from a Livestatus TCP-socket/file status.dat.
 *
 * @author Adenir Ribeiro Gomes
 */

public class Downtimes extends LiveStatusBase {

    /**
     * Constructor of table Downtimes
     *
     * @param path
     *            = "tcp://host:port" File : where path is the path to the file
     */
    public Downtimes(final String path) {
        super(path);
        this.initializeMaps();
        tableName = "downtimes";
    }
    ...
    /**
     * create the map for all columns description of table Downtimes. Key=column name, Value=column description
     *
     */
    public final void initializeMaps() {
        mapComments.put("author", "The contact that scheduled the downtime");
        mapComments.put("comment", "A comment text");
        mapComments.put("duration", "The duration of the downtime in seconds");
        mapComments.put("end_time", "The end time of the downtime as UNIX timestamp");
        mapComments.put("entry_time", "The time the entry was made as UNIX timestamp");
        mapComments.put("fixed", "A 1 if the downtime is fixed, a 0 if it is flexible");
        ...
        mapComments.put("id", "The id of the downtime");
        ...
        mapComments.put("start_time", "The start time of the downtime as UNIX timestamp");
        mapComments.put("triggered_by", "The id of the downtime this downtime was triggered by or 0 if it was not triggered by another downtime");
        mapComments.put("type", "The type of the downtime: 0 if it is active, 1 if it is pending");
    }
     ...
     * 
     * @return returns the value of the "duration" column as int
     */
    public int Duration() throws NumberFormatException {
        return this.getAsInt("duration");
    }

    /**
     * The end time of the downtime as UNIX timestamp
     * 
     * @return returns the value of the "end_time" column as time
     */
    public Date End_time() throws NumberFormatException {
        return this.getAsTime("end_time");
    }
     ...
     * 
     * @return returns the value of the "fixed" column as int
     */
    public int Fixed() throws NumberFormatException {
        return this.getAsInt("fixed");
    }
     ...
     * 
     * @return returns the value of the "start_time" column as time
     */
    public Date Start_time() throws NumberFormatException {
        return this.getAsTime("start_time");
    }

    /**
     * The id of the downtime this downtime was triggered by or 0 if it was not triggered by another downtime
     * 
     * @return returns the value of the "triggered_by" column as int
     */
    public int Triggered_by() throws NumberFormatException {
        return this.getAsInt("triggered_by");
    }
    ...
    /**
     * create the map for all columns of table Downtimes. Key=column name, Value=column value
     *
     * @param table
     *            LiveStatus table
     * @param filter
    ...
    public Map<String, String> asArrayString(final String table, final String filter) throws NumberFormatException {
        ...
        this.addToHashtable("duration", this.getAsString(this.Duration()));
        this.addToHashtable("end_time", this.getAsString(this.End_time()));
        this.addToHashtable("entry_time", this.getAsString(this.Entry_time()));
        this.addToHashtable("fixed", this.getAsString(this.Fixed()));
        ...
        this.addToHashtable("start_time", this.getAsString(this.Start_time()));
        this.addToHashtable("triggered_by", this.getAsString(this.Triggered_by()));
