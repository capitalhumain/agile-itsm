...
public class IntegranteViagemDTO extends BaseEntity {
    ...
    public void setIdIntegranteViagem(final Integer idIntegranteViagem) {
    ...
    public void setEmPrestacaoContas(final String emPrestacaoContas) {
    ...
    public void setEOu(final String eOu) {
        this.eOu = eOu;
    }
    ...
    public void setDataInicioAux(final Date dataInicioAux) {
    ...
    public void setDataFimAux(final Date dataFimAux) {
    ...
    public void setNomeDestino(final String nomeDestino) {
    ...
    public void setColDespesaViagemSerialize(final String colDespesaViagemSerialize) {
    ...
    public void setRemarcarRoteiro(final String remarcarRoteiro) {
