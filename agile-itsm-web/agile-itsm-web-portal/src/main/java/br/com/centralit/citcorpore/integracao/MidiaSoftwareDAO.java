...
public class MidiaSoftwareDAO extends CrudDaoDefaultImpl {
    ...
    public boolean consultarMidiasAtivas(final MidiaSoftwareDTO obj) throws PersistenceException {
        final List parametro = new ArrayList<>();
        List list = new ArrayList<>();
        String sql = "select idmidiasoftware From " + this.getTableName() + "  where  nome = ?   and dataFim is null ";
