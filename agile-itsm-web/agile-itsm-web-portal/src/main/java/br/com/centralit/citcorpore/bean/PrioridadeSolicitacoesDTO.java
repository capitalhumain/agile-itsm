 ...
 *
 */
public class PrioridadeSolicitacoesDTO extends BaseEntity {
     ...
     */
    public void setIdImpacto(final Integer idImpacto) {
    ...
    /**
     * @param impactosSerelializados
     *            the impactosSerelializados to set
     */
    public void setImpactosSerelializados(final String impactosSerelializados) {
        nivelImpactoSerelializado = impactosSerelializados;
    }
    ...
    /**
     * @param urgenciaSerelializados
     *            the urgenciaSerelializados to set
     */
    public void setUrgenciaSerelializados(final String urgenciaSerelializados) {
        nivelUrgenciaSerelializado = urgenciaSerelializados;
    }
    ...
    /**
     * @param matrizPrioridadeSelializado
     *            the matrizPrioridadeSelializado to set
     */
    public void setMatrizPrioridadeSelializado(final String matrizPrioridadeSelializado) {
    ...
    /**
     * @param listaImpacto
     *            the listaImpacto to set
     */
    public void setListaImpacto(final ArrayList<ImpactoDTO> listaImpacto) {
    ...
    /**
     * @param listaUrgencia
     *            the listaUrgencia to set
     */
    public void setListaUrgencia(final ArrayList<UrgenciaDTO> listaUrgencia) {
    ...
    /**
     * @param listaMatrizPrioridade
     *            the listaMatrizPrioridade to set
     */
    public void setListaMatrizPrioridade(final ArrayList<MatrizPrioridadeDTO> listaMatrizPrioridade) {
