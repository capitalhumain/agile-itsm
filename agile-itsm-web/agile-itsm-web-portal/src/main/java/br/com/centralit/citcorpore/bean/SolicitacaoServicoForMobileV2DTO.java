...
public class SolicitacaoServicoForMobileV2DTO {
    ...
    /**
     * @param idsolicitacaoIndividual
     *            the idsolicitacaoIndividual to set
     */
     ...
     *            the dataHoraSolicitacao to set
     */
    ...
    /**
     * @param prazoCapturaHH
     *            the prazoCapturaHH to set
     */
    ...
    /**
     * @param prazoCapturaMM
     *            the prazoCapturaMM to set
     */
     ...
     */
    public void setDataHoraFim(final String dataHoraFim) {
    ...
    /**
     * @param prazohhAnterior
     *            the prazohhAnterior to set
     */
    ...
    /**
     * @param prazommAnterior
     *            the prazommAnterior to set
     */
    ...
    /**
     * @param tempoDecorridoHH
     *            the tempoDecorridoHH to set
     */
    ...
    /**
     * @param tempoDecorridoMM
     *            the tempoDecorridoMM to set
     */
    ...
    /**
     * @param dataHoraSuspensao
     *            the dataHoraSuspensao to set
     */
    ...
    /**
     * @param dataHoraReativacao
     *            the dataHoraReativacao to set
     */
    ...
    /**
     * @param dataHoraCaptura
     *            the dataHoraCaptura to set
     */
    ...
    /**
     * @param tempoCapturaHH
     *            the tempoCapturaHH to set
     */
    ...
    /**
     * @param tempoCapturaMM
     *            the tempoCapturaMM to set
     */
    ...
    /**
     * @param tempoAtendimentoHH
     *            the tempoAtendimentoHH to set
     */
    ...
    /**
     * @param tempoAtendimentoMM
     *            the tempoAtendimentoMM to set
     */
    ...
    /**
     * @param dataHoraInicioSLA
     *            the dataHoraInicioSLA to set
     */
    ...
    /**
     * @param dataHoraSuspensaoSLA
     *            the dataHoraSuspensaoSLA to set
     */
    ...
    /**
     * @param dataHoraReativacaoSLA
     *            the dataHoraReativacaoSLA to set
     */
    ...
    /**
     * @param nomeElementoFluxo
     *            the nomeElementoFluxo to set
     */
