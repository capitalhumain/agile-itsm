...
public class Top10IncidentesRequisicoesDAO extends CrudDaoDefaultImpl {
    ...
    public ArrayList<Top10IncidentesRequisicoesDTO> listSolicitantesMaisAbriramIncSol(
        ...
        try {
            ...
            final boolean seLimita = relatorioTop10IncidentesRequisicoesDTO.getTopList() != null
                    && relatorioTop10IncidentesRequisicoesDTO.getTopList().intValue() > 0;
            ...
            if (relatorioTop10IncidentesRequisicoesDTO.getIdTipoDemandaServico() != null
                    && relatorioTop10IncidentesRequisicoesDTO.getIdTipoDemandaServico().intValue() > 0) {
            ...
            if (relatorioTop10IncidentesRequisicoesDTO.getSituacao() != null && !relatorioTop10IncidentesRequisicoesDTO.getSituacao().equalsIgnoreCase("0")
                    && relatorioTop10IncidentesRequisicoesDTO.getSituacao().length() > 0) {
    ...
    public ArrayList<Top10IncidentesRequisicoesDTO> listGruposMaisResolveramIncSol(
            final RelatorioTop10IncidentesRequisicoesDTO relatorioTop10IncidentesRequisicoesDTO) {
        List result;
        try {
            List resp = new ArrayList<>();
            ...
            sql.append("UPPER(solicitacaoservico.situacao)=UPPER('" + Enumerados.SituacaoSolicitacaoServico.Fechada.toString()
                    + "') and solicitacaoservico.idsolicitacaoservico=execucaosolicitacao.idsolicitacaoservico ");
            sql.append("join bpm_instanciafluxo on  execucaosolicitacao.idinstanciafluxo = bpm_instanciafluxo.idinstancia and UPPER(bpm_instanciafluxo.situacao) = UPPER('"
                    + br.com.centralit.bpm.util.Enumerados.INSTANCIA_ENCERRADA + "') ");
            ...
            sql.append("join bpm_atribuicaofluxo on (bpm_atribuicaofluxo.idgrupo is not null) and bpm_itemtrabalhofluxo.iditemtrabalho = bpm_atribuicaofluxo.iditemtrabalho and UPPER(bpm_atribuicaofluxo.tipo) = UPPER('"
                    + br.com.centralit.bpm.util.Enumerados.TipoAtribuicao.Automatica.toString() + "') ");
    ...
    public ArrayList<SolicitacaoServicoDTO> listDetalheGruposMaisResolveramIncSol(final Integer idGrupo,
            final RelatorioTop10IncidentesRequisicoesDTO relatorioTop10IncidentesRequisicoesDTO) {
        List result;
        try {
            List resp = new ArrayList<>();
            ...
            sql.append("UPPER(solicitacaoservico.situacao)=UPPER('" + Enumerados.SituacaoSolicitacaoServico.Fechada.toString()
                    + "') and solicitacaoservico.idsolicitacaoservico=execucaosolicitacao.idsolicitacaoservico ");
            sql.append("join bpm_instanciafluxo on  execucaosolicitacao.idinstanciafluxo = bpm_instanciafluxo.idinstancia and UPPER(bpm_instanciafluxo.situacao = '"
                    + br.com.centralit.bpm.util.Enumerados.INSTANCIA_ENCERRADA + "') ");
            sql.append("join bpm_itemtrabalhofluxo on ");
            sql.append("(bpm_itemtrabalhofluxo.datahorafinalizacao between ? and ?) and ");
            parametro.add(UtilDatas.getSqlDate(relatorioTop10IncidentesRequisicoesDTO.getDataInicial()));
            parametro.add(UtilDatas.getTimeStampComUltimaHoraDoDia(relatorioTop10IncidentesRequisicoesDTO.getDataFinal()));
            sql.append("execucaosolicitacao.idinstanciafluxo = bpm_itemtrabalhofluxo.idinstancia and (bpm_itemtrabalhofluxo.idresponsavelatual is not null) ");
            sql.append("join bpm_atribuicaofluxo on (bpm_atribuicaofluxo.idgrupo = ?) and bpm_itemtrabalhofluxo.iditemtrabalho = bpm_atribuicaofluxo.iditemtrabalho and bpm_atribuicaofluxo.tipo = '"
                    + br.com.centralit.bpm.util.Enumerados.TipoAtribuicao.Automatica.toString() + "' ");
    ...
    public ArrayList<Top10IncidentesRequisicoesDTO> listReqIncMaisSolicitados(
            final RelatorioTop10IncidentesRequisicoesDTO relatorioTop10IncidentesRequisicoesDTO) {
        List result;
        try {
            List resp = new ArrayList<>();
    ...
    public ArrayList<SolicitacaoServicoDTO> listDetalheReqIncMaisSolicitados(final Integer idTipoDemanda, final Integer idServico,
            final RelatorioTop10IncidentesRequisicoesDTO relatorioTop10IncidentesRequisicoesDTO) {
        List result;
        try {
            List resp = new ArrayList<>();
    ...
    public ArrayList<Top10IncidentesRequisicoesDTO> listUnidadesMaisAbriramReqInc(
            final RelatorioTop10IncidentesRequisicoesDTO relatorioTop10IncidentesRequisicoesDTO) {
        List result;
        try {
            List resp = new ArrayList<>();
    ...
    public ArrayList<SolicitacaoServicoDTO> listDetalheUnidadesMaisAbriramReqInc(final Integer idUnidade,
            final RelatorioTop10IncidentesRequisicoesDTO relatorioTop10IncidentesRequisicoesDTO) {
        List result;
        try {
            List resp = new ArrayList<>();
    ...
    public Collection<SolicitacaoServicoDTO> listDetalheLocMaisAbriramReqInc(final Integer idLocalidade,
            final RelatorioTop10IncidentesRequisicoesDTO relatorioTop10IncidentesRequisicoesDTO) {
        List result;
        try {
            List resp = new ArrayList<>();
