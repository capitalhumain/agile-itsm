...
/**
 * Class Servicesbyhostgroup is the main class for obtain all columns of table "servicesbyhostgroup"
 * from a Livestatus TCP-socket/file status.dat.
 *
 * @author Adenir Ribeiro Gomes
 */

public class Servicesbyhostgroup extends LiveStatusBase {

    /**
     * Constructor of table Servicesbyhostgroup
     *
     * @param path
     *            = "tcp://host:port" File : where path is the path to the file
     */
    public Servicesbyhostgroup(final String path) {
        super(path);
        this.initializeMaps();
    ...
    /**
     * create the map for all columns description of table Servicesbyhostgroup. Key=column name, Value=column description
     *
     */
    ...
    /**
     * create the map for all columns of table Servicesbyhostgroup. Key=column name, Value=column value
     *
     * @param table
     *            LiveStatus table
     * @param filter
