...
public class AnaliseTendenciasDAO extends CrudDaoDefaultImpl {
    ...
    public ArrayList<TendenciaGanttDTO> montarPeriodo(final AnaliseTendenciasDTO analiseTendenciasDTO, final ArrayList<TendenciaGanttDTO> resultado) {
        final ArrayList<TendenciaGanttDTO> listaPeriodo = new ArrayList<TendenciaGanttDTO>();
        try {
            ...
            do {
                ...
                if (resultado != null && resultado.size() > 0) {
                    for (final TendenciaGanttDTO tendenciaGanttDTO : resultado) {
                ...
                if (DataAux.before(DataFim)) {
                    final java.util.Date utilDate = UtilDatas.incrementaDiasEmData(DataAux, 1);
    ...
    public List<TendenciaDTO> buscarTendenciasServico(final AnaliseTendenciasDTO analiseTendenciasDTO) {
        List result;
        try {
        ...
        return result == null || result.size() <= 0 ? new ArrayList<TendenciaDTO>() : result;
    }

    public List<TendenciaDTO> buscarTendenciasCausa(final AnaliseTendenciasDTO analiseTendenciasDTO) {
        List result;
        try {
            List resp = new ArrayList<>();
            final List parametro = new ArrayList<>();
    ...
    public List<TendenciaDTO> buscarTendenciasItemConfiguracao(final AnaliseTendenciasDTO analiseTendenciasDTO) {
        List result;
        try {
            List resp = new ArrayList<>();
            final List parametro = new ArrayList<>();
    ...
    public List<TendenciaGanttDTO> listarGraficoGanttServico(final AnaliseTendenciasDTO analiseTendenciasDTO, final Integer idServico) {
        List result;
        try {
            List resp = new ArrayList<>();
            final List parametro = new ArrayList<>();
            ...
            resp = this.execSQL(sql.toString(), parametro.toArray());
            result = engine.listConvertion(TendenciaGanttDTO.class, resp, listRetorno);
        } catch (final PersistenceException e) {
            e.printStackTrace();
            result = null;
        } catch (final Exception e) {
        ...
        return result == null || result.size() <= 0 ? new ArrayList<TendenciaGanttDTO>() : result;
    }

    public List<TendenciaGanttDTO> listarGraficoGanttCausa(final AnaliseTendenciasDTO analiseTendenciasDTO, final Integer idCausa) {
        List result;
        try {
            List resp = new ArrayList<>();
            final List parametro = new ArrayList<>();
    ...
    public List<TendenciaGanttDTO> listarGraficoGanttItemConfiguracao(final AnaliseTendenciasDTO analiseTendenciasDTO, final Integer idItemConfiguracao) {
        List result;
        try {
            List resp = new ArrayList<>();
            final List parametro = new ArrayList<>();
