...
public class ImportConfigDao extends CrudDaoDefaultImpl {
     ...
     * @throws Exception
     */
    public ImportConfigDTO consultarImportConfigDTO(final ImportarDadosDTO importarDadosDTO) throws PersistenceException {
        ...
        final List<ImportConfigDTO> lista = (List<ImportConfigDTO>) super.findByCondition(condicao, ordenacao);
