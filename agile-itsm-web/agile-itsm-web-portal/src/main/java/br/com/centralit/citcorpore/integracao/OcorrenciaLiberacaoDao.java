...
public class OcorrenciaLiberacaoDao extends CrudDaoDefaultImpl {
    ...
    public Collection findByIdRequisicaoLiberacao(final Integer idRequisicaoLiberacao) throws PersistenceException {
    ...
    public Collection<OcorrenciaMudancaDTO> listByIdMudancaAndCategoria(final Integer idRequisicaoLiberacao, final CategoriaOcorrencia categoria)
