...
public class UploadPlanoDeReversaoControl extends BodyTagSupport {
    ...
    private static final long serialVersionUID = -3905925734239174482L;
    ...
    public int doStartTag() throws JspException {
        try {
            ...
            out.println("<div style='border:1px solid black; height: 480px' id='divUpload_" + this.getId() + "'>\n");
            ...
            if (!UtilStrings.nullToVazio(disabled).equalsIgnoreCase("true")) {
                ...
                out.println("</td>");
                out.println("<td>");
                out.println("<input type='text' name='descUploadFile_" + this.getId() + "' id='descUploadFile_" + this.getId() + "' size='50' maxlength='70'/>");
                out.println("</tr>");
                out.println("<tr>");
                out.println("<td>");
                ...
                out.println("</td>");
                out.println("<td>");
                out.println("<input type='text' name='versao_" + this.getId() + "' id='versao_" + this.getId() + "' size='20' maxlength='20'/>");
                out.println("</td>");
                out.println("</tr>");
                out.println("<tr>");
                out.println("<td>");
                ...
                out.println("</td>");
                out.println("<td>");
                out.println("<input type='button' class='ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only' name='btnAdd" + this.getId()
                        + "' value='" + UtilI18N.internacionaliza((HttpServletRequest) pageContext.getRequest(), "citcorpore.comum.adicionar") + "' title=' "
