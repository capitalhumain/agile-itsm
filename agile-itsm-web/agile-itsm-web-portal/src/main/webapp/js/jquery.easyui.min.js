...
(function($) {
	...
	$.fn.panel.defaults = {
		...
		tools : null,
		href : null,
		loadingMessage : i18n_message("citcorpore.comum.aguardeCarregando..."),
...
(function($) {
	...
	$.fn.validatebox.defaults = {
		required : false,
		validType : null,
		missingMessage : i18n_message("citcorpore.ui.mensagem.Campos_com_preenchimento_obrigatorio"),
		invalidMessage : null,
		rules : {
			email : {
				...
				message : i18n_message("citcorpore.comum.enderecoValido") 
			},
			url : {
				...
				message : i18n_message("citcorpore.comum.urlValida")
			},
			length : {
				...
				message : i18n_message("citcorpore.comum.valorEntre")
			},
			remote : {
				...
				message : i18n_message("citcorpore.comum.corrigirCampo")
			}
		}
	};
})(jQuery);
	...
	var _545 = {
		...
		datepicker : {
			init : function(_546, _547) {
				var _548 = "";
				if(_547 != undefined){
					_548 = $("<input type=\"text\" maxlength=\""+_547.maxlength+"\" class=\"datagrid-editable-input datepicker \">").appendTo(_546);
				}else{
					_548 = $("<input type=\"text\" class=\"datagrid-editable-input datepicker \">").appendTo(_546);
				}
				return _548;
			},
			getValue : function(_549) {
