...
ALTER TABLE coletapreco ALTER COLUMN prazomediopagto TYPE numeric(10,2);

-- INICIO - thyen.chang - 27.11.2014

ALTER TABLE coletapreco ALTER COLUMN prazomediopagto TYPE integer(11);
...
alter table itemconfiguracao alter nome set not null;
alter table itemconfiguracao add informacoesadicionais varchar(4000) default '' not null;

-- FIM - thyen.chang - 02/12/2014ALTER TABLE coletapreco ALTER COLUMN prazomediopagto TYPE numeric(10,2);

-- INICIO - thyen.chang - 03/12/2014

alter table itemconfiguracao add idgruporesponsavel integer;

-- FIM - thyen.chang - 03/12/2014
...
ALTER TABLE itemconfiguracao ALTER COLUMN nome DROP NOT NULL;
ALTER TABLE itemconfiguracao ALTER COLUMN informacoesadicionais DROP NOT NULL;
