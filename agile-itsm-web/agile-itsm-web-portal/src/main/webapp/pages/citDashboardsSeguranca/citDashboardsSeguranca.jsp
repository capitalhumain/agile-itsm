...
<head>
	...
	<script>
		...
		function abrirPopup(id, text){
			...
			if (id != null){
				emiteAguarde();
				document.formPainel.idDashBoard.value = StringUtils.onlyNumbers(id);
				document.formPainel.fireEvent('mostraSeguranca');
			}
		}
	</script>
...
<body id="bodyNode">
 <div id="wrapper">
		...
		<%}%>
			...
			%>
	<form name='formPainel' method="POST" action='<%=Constantes.getValue("CONTEXTO_APLICACAO")%>/pages/citDashboardsSeguranca/citDashboardsSeguranca'>
		<input type='hidden' name='idDashBoard'/>
		&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<tr>
				<td>
					<div id='divLista' style='height: 600px; width: 250px; border: 1px solid black; overflow: auto'>
						<div id="infoDiv" style="font-weight: bold;"><fmt:message key="dashboard.dashboards"/></div>
						<br>
