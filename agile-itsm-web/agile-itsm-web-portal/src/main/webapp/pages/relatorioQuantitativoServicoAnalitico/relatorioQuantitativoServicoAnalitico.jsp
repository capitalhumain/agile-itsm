...
<head>
	...
	<link rel="stylesheet" type="text/css" href="./css/relatorioQuantitativoServicoAnalitico.css" />
	...
	<div id="wrapper">
		...
		<div id="main_container" class="main_container container_16 clearfix">
			...
			<div class="flat_area grid_16">
				<h2><fmt:message key="relatorioQuantitativo.relatorioQuantitativoServicoConcluidosAnalitico"/></h2>
			</div>
			<div class="box grid_16 tabs">
				<ul class="tab_header clearfix">
					<li><a href="#tabs-1"><fmt:message key="relatorioQuantitativo.relatorioQuantitativoServicoConcluidosAnalitico" /></a></li>
				</ul>
