...
<link rel="stylesheet" type="text/css" href="./css/relatorioServicoAprovar.css" />

<script type="text/javascript" src="./js/relatorioServicoAprovar.js"></script>
</head>
<!-- Definicoes Comuns -->
		...
		<div id="main_container" class="main_container container_16 clearfix">
			...
			<div class="box grid_16 tabs">
				<ul class="tab_header clearfix">
					<li><a href="#tabs-1"><fmt:message key="relatorioAprovacaoSolicitacoes" /></a></li>
				</ul>
				<a href="#" class="toggle">&nbsp;</a>
				<div class="toggle_container">
					<div class="block" >
						<div id="parametros">
							<form name='form' action='${ctx}/pages/relatorioServicoAprovar/relatorioServicoAprovar'>
								...
								<div class="columns clearfix">
									...
									<div class="col_25">
										<fieldset style="height: 64px">
											<label><fmt:message key="citcorpore.comum.registros" /></label>
											<div>
