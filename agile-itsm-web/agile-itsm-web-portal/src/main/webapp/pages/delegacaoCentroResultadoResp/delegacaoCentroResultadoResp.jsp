...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="./css/delegacaoCentroResultadoResp.css" />
...
<cit:janelaAguarde id="JANELA_AGUARDE_MENU"  title="" style="display:none;top:325px;width:300px;left:500px;height:50px;position:absolute;">
		...
		%>
			...
			%>
				<div class="flat_area grid_16">
					<h2>
						<fmt:message key="delegacaoCentroResultadoResp" />
					</h2>
				</div>
				<div class="box grid_16 tabs">
					...
					<div class="toggle_container">
						<div id="tabs-1" class="block">
							<div class="section">
								<form name="form" action="${ctx}/pages/delegacaoCentroResultadoResp/delegacaoCentroResultadoResp">
									...
									<div class="columns clearfix">
		                                ...
		                                <div class="col_100">
	                                        <h2 class="section">
	                                            <fmt:message key="delegacaoCentroResultado.alcadas" />
	                                        </h2>
		                                </div>
		...
		<div id="POPUP_DELEGACAO" title="<fmt:message key="delegacaoCentroResultado.delegacao" />" style="overflow: hidden;">
		    <form name='formDelegacao' action="${ctx}/pages/delegacaoCentroResultadoResp/delegacaoCentroResultadoResp">
