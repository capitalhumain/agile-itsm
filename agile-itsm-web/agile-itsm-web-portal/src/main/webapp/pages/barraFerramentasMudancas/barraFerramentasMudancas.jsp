...
<body>
	<input type="hidden" id="idRequisicaoMudanca" />
		...
		<div id="main_container" class="container_16 clearfix">
			<div class="box grid_16 tabs">
				...
				<div class="toggle_container">
					<form name="formOcorrenciaMudanca" method="post" action="${ctx}/pages/ocorrenciaMudanca/ocorrenciaMudanca">
	...
	<script type="text/javascript" src="${ctx}/pages/barraFerramentasMudancas/js/barraFerramentasMudancas.js"></script>
</body>
</html>
