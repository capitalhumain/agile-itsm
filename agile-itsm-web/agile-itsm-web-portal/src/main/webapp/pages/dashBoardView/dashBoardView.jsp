...
<html>
<head>
<script type="text/javascript" src="./js/dashBoardView.js"></script>
	...
	<link rel="stylesheet" type="text/css" src="css/dashBoardView.css"></script>
	...
	<script type="text/javascript" src="${ctx}/js/jquery.ui.datepicker-pt-BR.js"></script>
	...
	<frameset rows="5%,*">
	<frame src="${ctx}/pages/dashBoardView/topDashboarView.jsp" name="top" scrolling="no">
	<frameset cols="15%,*">
	<frame NAME="esquerda" src="${ctx}/pages/listagemDashBoards/listagemDashBoards.load?view=true" borderCOLOR="#3F85B8" target="main">
	<frame NAME="direita" id="direita" src="${ctx}/pages/dashBoardViewInternal/dashBoardViewInternal.load" borderCOLOR="#4086C6" target="direita">
	</frameset>
		<noframes>
		<body>
		</body>
