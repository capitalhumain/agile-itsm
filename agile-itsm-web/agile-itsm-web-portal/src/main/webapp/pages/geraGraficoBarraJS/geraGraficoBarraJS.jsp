...
String textJSON_Columns = (String)request.getAttribute("textJSON_Columns");
textJSON_Columns = UtilStrings.nullToVazio(textJSON_Columns);
...
var intervalo;
	...
	<script class="include" type="text/javascript" src="${ctx}/pages/graficos/plugins/jqplot.barRenderer.min.js"></script>
	<script class="include" type="text/javascript" src="${ctx}/pages/graficos/plugins/jqplot.categoryAxisRenderer.min.js"></script>
	<script class="include" type="text/javascript" src="${ctx}/pages/graficos/plugins/jqplot.pointLabels.min.js"></script>
...
<body>
    		...
    		function gerarPainel(){
    			...
    			//if(validaData(dataInicio, dataFim)){
    				if (document.formParametros.validate())
    				{
    					...
    					fecharTelaParm();
    	                $.getJSON("${ctx}/pages/geraGraficoBarraJS/geraGraficoBarraJS.load?" + queryStr, function(mps) {
    	 	            	var plot1 = $.jqplot('output', mps.dados, {
        ...
        %>
        <div id="output" style="margin: 2px; width: 95%; height: 95%">
