...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${ctx}/pages/barraFerramentasIncidentes/css/barraFerramentasIncidentes.css">
</head>
<body>
	...
	<div align="center" id="barraFerramentasIncidentes">
		<ul class="menu_horizontal">
			...
			<li style="cursor: pointer;" class="li_menu tooltip_bottom" id="btIncidentesRelacionados" title='<fmt:message key="gerenciaservico.vincularincidentesrelacionados" />'>
				<img src="${ctx}/template_new/images/icons/small/grey/strategy.png" >
				<div class="name"><fmt:message key="gerenciaservico.incidentesrelacionados" /></div>
			</li>
			<% if (id == null ) { %>
	...
	<div class="POPUP_barraFerramentasIncidentes" id="POPUP_menuAnexos" style="display:none">
		<form name="formUpload" method="post" enctype="multipart/form-data">
			<cit:uploadControl id="uploadAnexos" title="Anexos" style="height: 100px; width: 50%; border: 1px solid black;"
				form="document.formUpload" action="/pages/upload/upload.load" disabled="false" />
						...
						<div id="tabs-2" class="block">
							<div class="section">
								...
								<div class="columns clearfix">
									<div class="col_20">
										<fieldset>
											<label class="campoObrigatorio"><fmt:message key="ocorrenciaSolicitacao.tempoGasto" /></label>
											<div>
									...
									<div class="col_50">
										<fieldset>
											<label class="campoObrigatorio"><fmt:message key="ocorrenciaSolicitacao.registradopor" /></label>
											<div>
												<input type="text" name="registradopor" id="registradopor" maxlength="30" size="30" readonly="readonly" class="Valid[Required] Description[Registrado por]" />
											</div>
										</fieldset>
									</div>
								</div>
	...
	<script type="text/javascript" src="${ctx}/pages/barraFerramentasIncidentes/js/barraFerramentasIncidentes.js"></script>
</body>
</html>
