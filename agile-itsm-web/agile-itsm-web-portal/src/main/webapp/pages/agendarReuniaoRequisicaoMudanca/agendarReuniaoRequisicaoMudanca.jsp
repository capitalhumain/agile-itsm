...
<!-- Conteudo -->
 <div id="main_container" class="main_container container_16 clearfix">
		...
		<div class="flat_area grid_16">
				<h2><fmt:message key="reuniao.agendaReuniaoMudanca"/>&nbsp;N&deg; &nbsp;<%=idRequisicaoMudanca%></h2>
		</div>
  <div class="box grid_16 tabs">
	 ...
	 <form name='form' action='${ctx}/pages/agendarReuniaoRequisicaoMudanca/agendarReuniaoRequisicaoMudanca'>
						...
						<div id="tabs-2" class="block">
								...
								<div class="columns clearfix">
									...
									<div class="col_100">
										<fieldset>
											<label style="cursor: pointer;"><fmt:message key='reuniao.localReuniao' /></label>
											<div>
											<table>
											<tr>
											<td>
										...
										<fieldset id='fldOrientacao'>
											<label style="cursor: pointer;"><fmt:message key='reuniao.descricaoReuniao' /></label>
											<div>
...
<!-- Fim da Pagina de Conteudo -->
	...
	<script src="js/agendarReuniaoRequisicaoMudanca.js"></script>
</body>
