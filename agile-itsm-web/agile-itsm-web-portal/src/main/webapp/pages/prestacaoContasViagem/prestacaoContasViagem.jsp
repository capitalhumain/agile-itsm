<%@page import="br.com.centralit.citcorpore.bean.IntegranteViagemDTO"%>
...
<html>
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="css/prestacaoContasViagem.css" />
    ...
    <body>
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body">
                            <div class="widget" data-toggle="collapse-widget">
                                <div class="widget-head">
                                    <h3 class="heading" id="nomeIntegranteViagem"></h3>
                                </div><!-- .widget-head -->

                                <div class="widget-body">
                                    <div class="row-fluid">
                                        <div class="span3">
                                             <label class="campoObrigatorio strong"><fmt:message key="prestacaoContas.numeroNf" /></label>
                                            <input type="text" name="numeroDocumento" id="numeroDocumento" maxlength="50" class="Valid[Required] Description[prestacaoContas.numeroNf] span12" />
                                         </div><!-- .span3 -->

                                         <div class="span3">
                                             <label class="campoObrigatorio strong"><fmt:message key="prestacaoContas.dataEmissaoNf"/></label>
                                            <input type="text" class="Valid[Required] Format[Date] Valid[Date] datepicker span12" maxlength="0" id="data" name="data">
                                         </div><!-- .span3 -->

                                         <div class="span6">
                                            <label class="campoObrigatorio strong"><fmt:message key="prestacaoContas.estabelecimentoEmissorNf"/></label>
                                            <input type='text' class="span12" name="nomeFornecedor" id="nomeFornecedor" maxlength="100" size="100" />
                                        </div><!-- .span6 -->
                                    </div><!-- .row-fluid -->

                                    <div class="row-fluid">
                                         <div class="span3">
                                                 <label class="campoObrigatorio strong"><fmt:message key="prestacaoContas.valorNf" /></label>
                                         ...
                                         <div class="span9">
                                             <label class="campoObrigatorio strong"><fmt:message key="prestacaoContas.descricaoDespesa"/></label>
                            ...
                            <div class="box-generic">
                                <div class="row-fluid">
                                    <div class="span4">
                                        ...
                                        <input type="text" name="totalPrestacaoContas" id="totalPrestacaoContas" readonly="true" class="span12" />
                                    </div><!-- .span4 -->

                                    <div class="span4">
                                        <label class="strong"><fmt:message key="requisicaoViagem.totalLancamento" /></label>
                                        <input type="text" name="totalLancamentos" id="totalLancamentos" readonly="true" class="span12" />
                                    </div><!-- .span4 -->
        ...
        <script src="js/prestacaoContasViagem.js"></script>
    </body>
</html>