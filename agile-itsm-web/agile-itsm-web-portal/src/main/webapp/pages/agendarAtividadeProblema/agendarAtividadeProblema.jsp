...
<!-- Conteudo -->
 <div id="main_container" class="main_container container_16 clearfix">
		...
		<div class="flat_area grid_16">
				<h2><fmt:message key="problema.problema"/>&nbsp;N&deg; &nbsp;<%=idProblema%></h2>
		</div>
  <div class="box grid_16 tabs">
	 ...
	 <div class="toggle_container">
						...
						<div id="tabs-2" class="block">
							<form name='form' action='${ctx}/pages/agendarAtividadeProblema/agendarAtividadeProblema'>
								<div class="columns clearfix">
									...
									<div class="col_100">
										<fieldset>
											<label style="cursor: pointer;" class="campoObrigatorio"><fmt:message key='gerenciaservico.agendaratividade.crupoatividades' /></label>
											<div>
										...
										<fieldset id='fldIniciarEm'>
											<label style="cursor: pointer;" class="campoObrigatorio"><fmt:message key='gerenciaservico.agendaratividade.agendarpara' /></label>
											<div>
												<table>
													<tr>
														<td>
										...
										<fieldset id='fldDuracaoEstimada'>
											<label style="cursor: pointer;" class="campoObrigatorio"><fmt:message key='gerenciaservico.agendaratividade.duracaoestimada' /> </label>
											<div>
												<table>
													<tr>
														<td>
...
<script type="text/javascript" src="js/agendarAtividadeProblema.js"></script>
</body>
