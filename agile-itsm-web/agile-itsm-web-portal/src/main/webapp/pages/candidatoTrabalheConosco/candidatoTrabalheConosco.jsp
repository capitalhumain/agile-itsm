        ...
        <div class="<%=(iframe == null) ? "container-fluid fixed" : "" %>">
            ...
            <div id="wrapper" class="<%=(iframe == null) ? "" : "nowrapper" %>">
                ...
                <div id="footer" class="hidden-print">
                    <div class="copy">© 2014 - <a target="_blank" href="http://www.agileitsm.com.br"><fmt:message key="citcorpore.comum.title"/></a> - <fmt:message key="citcorpore.todosDireitosReservados"/> - <fmt:message key="login.versao"/> <b><%=Versao.getDataAndVersao()%> </div>
                </div>
