	...
	<div id="wrapper">
		...
		<%if (iframe == null) {%>
			...
			<div class="flat_area grid_16">
				<h2>
					<fmt:message key="menu.nome.curso" />
				</h2>
			</div>
			<div class="box grid_16 tabs">
				<ul class="tab_header clearfix">
					<li><a href="#tabs-1"><fmt:message key="solicitacaoCargo.cadastroCurso" />
					</a></li>
					<li><a href="#tabs-2" class="round_top"><fmt:message key="solicitacaoCargo.pesquisaCurso" />
					</a></li>
				</ul>
