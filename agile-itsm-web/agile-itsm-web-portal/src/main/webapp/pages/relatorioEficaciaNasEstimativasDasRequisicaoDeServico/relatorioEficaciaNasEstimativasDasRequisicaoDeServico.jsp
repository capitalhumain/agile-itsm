...
<link type="text/css" rel="stylesheet"
	...
	<link rel="stylesheet" type="text/css" href="./css/relatorioEficaciaNasEstimativasDasRequisicaoDeServico.css" />
</head>
...
<body>
					...
					<div class="innerLR">
						<div class="widget">
							<div class="widget-head">
								<h4 class="heading">
									<fmt:message key="relatorioEficaciaDasNasEstimativasdeServico.titulo" />
								</h4>
							</div>
							<div class="widget-body collapse in">
								<form name="form" id="form"action="${ctx}/pages/relatorioEficaciaNasEstimativasDasRequisicaoDeServico/relatorioEficaciaNasEstimativasDasRequisicaoDeServico.load">
	...
	<script type="text/javascript" src="./js/relatorioEficaciaNasEstimativasDasRequisicaoDeServico.js"></script>
</body>
</html>
