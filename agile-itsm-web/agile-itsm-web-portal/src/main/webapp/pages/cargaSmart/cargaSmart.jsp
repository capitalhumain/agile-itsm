	...
	<div id="wrapper">
		...
		<div id="main_container" class="main_container container_16 clearfix">
			...
			<div class="flat_area grid_16">
				<h2>
					<fmt:message key="carga.citSmart" />
				</h2>
			</div>
			...
			<div class="box grid_16 tabs">
				...
				<ul class="tab_header clearfix">
					<li><a href="#tabs-1"><fmt:message key="carga.citSmart" /></a></li>
				</ul>
...
<!-- 									<div class="col_16">
								...
								<div id='divEnviarArquivo' style='display:block; padding: 5px;'>
									...
									<form name='form' method="post" ENCTYPE="multipart/form-data" action='${ctx}/pages/cargaSmart/cargaSmart.load'>
