...
<!-- Conteudo -->
 <div id="main_container" class="main_container container_16 clearfix">
		...
		<div class="flat_area grid_16">
				<h4><fmt:message key="requisicaoLiberacao.requisicaoLiberacao"/>&nbsp;N&deg; &nbsp;<%=idRequisicaoLiberacao%></h4>
		</div>
  <div class="box grid_16 tabs">
	 ...
	 <div class="toggle_container">
						...
						<div id="tabs-2" class="block">
							<form name='form' action='${ctx}/pages/agendarAtividadeRequisicaoLiberacao/agendarAtividadeRequisicaoLiberacao'>
								<div class="columns clearfix">
									...
									<div class="col_100">
										<fieldset>
											...
											<div>
												<select name='idGrupoAtvPeriodica' <%--class=" Valid[Required]--%> Description[<fmt:message key='gerenciaservico.agendaratividade.crupoatividades' />]">
												</select>
											</div>
										</fieldset>
										<fieldset id='fldOrientacao'>
											...
											<div>
												<textarea <%--class=" Valid[Required]--%> Description[<fmt:message key='gerenciaservico.agendaratividade.crupoatividades' />]" name="orientacaoTecnica" cols='90' rows='5'></textarea>
											</div>
										</fieldset>
										<fieldset id='fldIniciarEm'>
											<label class="campoObrigatorio" style="cursor: pointer;"><fmt:message key='gerenciaservico.agendaratividade.agendarpara' /></label>
											<div>
												<table>
													<tr>
														<td>
										...
										<fieldset id='fldDuracaoEstimada'>
											<label class="campoObrigatorio" style="cursor: pointer;"><fmt:message key='gerenciaservico.agendaratividade.duracaoestimada' /> </label>
											<div>
												<table>
													<tr>
														<td>
...
<!-- Fim da Pagina de Conteudo -->
	...
	<script src="js/agendarAtividadeRequisicaoLiberacao.js"></script>
</body>
