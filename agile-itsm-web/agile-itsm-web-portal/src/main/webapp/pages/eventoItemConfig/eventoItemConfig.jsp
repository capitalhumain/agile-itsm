...
<body>
	...
	<div class="flat_area grid_16">
		<h2><fmt:message key="eventoItemConfiguracao.eventos" /></h2>
	</div>
		...
		<div class="col_33">
			<fieldset>
				...
				<div class="inline clearfix">
					<label><input type='radio' id="ligarCasoDesl" name="ligarCasoDesl" value="S" class="Valid[Required] Description[eventoItemConfiguracao.ligarMaquina]" /><fmt:message key="eventoItemConfiguracao.ligarMaquinaSim" /></label>
					<label><input type='radio' id="ligarCasoDesl" name="ligarCasoDesl" value="N" class="Valid[Required] Description[eventoItemConfiguracao.ligarMaquina]" /><fmt:message key="eventoItemConfiguracao.ligarMaquinaNao" /></label>
				</div>
			</fieldset>
		</div>
	</div>
	...
	<div class="columns clearfix">
		<div class="col_100">
			<fieldset>
				<label class="campoObrigatorio" id="addGrupoItemConfig" style="cursor: pointer;" title="Clique para adicionar um grupo de item de configuração!"><fmt:message key="eventoItemConfiguracao.grupo" /><img src="${ctx}/imagens/add.png"></label>
				<div>
	...
	<div class="columns clearfix">
		...
		<div class="col_33" id="divComandoLinux" style="display: none;">
			<fieldset>
				<label class="campoObrigatorio"><fmt:message key="eventoItemConfiguracao.linhaComandoLinux"/></label>
				<div>
