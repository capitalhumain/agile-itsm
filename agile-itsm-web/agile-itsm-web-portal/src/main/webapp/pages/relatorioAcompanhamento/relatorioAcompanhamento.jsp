...
<link rel="stylesheet" type="text/css" href="./css/relatorioAcompanhamento.css">

<script type="text/javascript" src="./js/relatorioAcompanhamento.js"></script>
		...
		<div id="main_container" class="main_container container_16 clearfix">
			...
			<div class="box grid_16 tabs">
				<ul class="tab_header clearfix">
					<li><a href="#tabs-1"><fmt:message key="relatorioAcompanhamento.relatorioAcompanhamento" /></a></li>
				</ul>
				<div class="toggle_container">
					<div class="block" >
						...
						<div class="section">
							<form name='form'
								action='${ctx}/pages/relatorioAcompanhamento/relatorioAcompanhamento'>
