...
<link rel="stylesheet" type="text/css" href="./css/relatorioPesquisaSatisfacao.css" />

<script type="text/javascript" src="./js/relatorioPesquisaSatisfacao.js"></script>
</head>
<!-- Definicoes Comuns -->
		...
		<div id="main_container" class="main_container container_16 clearfix">
			...
			<div class="box grid_16 tabs">
				<ul class="tab_header clearfix">
					<li><a href="#tabs-1"><fmt:message key="relatoriopesquisasatisfacao.titulo" /></a></li>
				</ul>
				...
				<div class="toggle_container">
					<div class="block" >
						<div id="parametros">
							<form name='form'
								action='${ctx}/pages/relatorioPesquisaSatisfacao/relatorioPesquisaSatisfacao'>
								...
								<div class = "col_25">
									...
									<div class="col_25">
										<fieldset  style="height: 64px !important;">
											<label><fmt:message key="relatoriopesquisasatisfacao.nota" /></label>
											<div>
									...
									<div class="col_10">
										<fieldset style="height: 64px">
											...
											<div>
												<select id="topList" name="valorTopList"></select>
								</div>
										</fieldset>
									</div>
								</div>
