...
<head>
	...
	<link rel="stylesheet" type="text/css" href="./css/relatorioQuantitativo.css" />

<script type="text/javascript" src="./js/relatorioQuantitativo.js"></script>
</head>
		...
		<div id="main_container" class="main_container container_16 clearfix">
			...
			<div class="box grid_16 tabs">
				<ul class="tab_header clearfix">
					<li><a href="#tabs-1"><fmt:message key="relatorioQuantitativo.relatorioQuantitativo" /></a></li>
				</ul>
				...
				<div class="toggle_container">
					<div class="block" >
						<div id="parametros">
							<form name="form"
								action="${ctx}/pages/relatorioQuantitativo/relatorioQuantitativo">
								...
								<div class="columns clearfix">
									...
									<div class="col_25">
										<fieldset style="height: 64px">
											<label><fmt:message key="citcorpore.comum.tipoUsuario" /></label>
											<div>
												<select name="tipoUsuario">
													<option value=""><fmt:message key="citcorpore.comum.todos" /></option>
													<option value="usuarioVip"><fmt:message key="citcorpore.comum.usuarioVip" /></option>
													<option value="usuarioNormal"><fmt:message key="citcorpore.comum.usuarioNormal" /></option>
												</select>
											</div>
										</fieldset>
									</div>
								...
								<div class="col_100">
									...
									<button type='button' name='btnRelatorio' class="light"
											onclick='javascript:imprimirRelatorioQuantitativo();'
