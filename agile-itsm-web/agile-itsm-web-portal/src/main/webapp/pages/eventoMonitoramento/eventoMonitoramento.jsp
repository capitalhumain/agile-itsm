...
<script type="text/javascript" src="./js/eventoMonitoramento.js"></script>
<%//se for chamado por iframe deixa apenas a parte de cadastro da página
			if (iframe != null) {%>
<link rel="stylesheet" type="text/css" href="./css/eventoMonitoramento.css" />
<%}%>
</head>
<body>
	...
	<div id="wrapper">
		...
		<div class="flat_area grid_16">
				<h2>
					<fmt:message key="eventoMonitoramento.Evento" />
				</h2>
			</div>
			<div class="box grid_16 tabs">
				<ul class="tab_header clearfix">
					<li><a href="#tabs-1"><fmt:message key="eventoMonitoramento.Cadastro" /></a></li>
					<li><a href="#tabs-2" class="round_top"><fmt:message key="eventoMonitoramento.Pesquisa" /></a></li>
				</ul>
				<a href="#" class="toggle">&nbsp;</a>
				<div class="toggle_container">
					<div id="tabs-1" class="block">
						<div class="section">
							<form name='form' action='${ctx}/eventoMonitoramento/eventoMonitoramento'>
								<input type='hidden' id='idEventoMonitoramento' name='idEventoMonitoramento'/>

								<div class="columns clearfix">
									<div class="col_33">
										<fieldset>
											<label class="campoObrigatorio"><fmt:message key="eventoMonitoramento.nomeEvento" /></label>
											<div>
												<input type='text' name="nomeEvento" maxlength="200" class="Valid[Required] Description[eventoMonitoramento.nomeEvento]"/>
											</div>
										</fieldset>
										<fieldset>
											<label><fmt:message key="eventoMonitoramento.detalhamento" /></label>
											<div>
