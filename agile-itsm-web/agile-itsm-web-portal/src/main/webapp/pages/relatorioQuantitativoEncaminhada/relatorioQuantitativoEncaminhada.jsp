...
<link rel="stylesheet" type="text/css" href="./css/relatorioQuantitativoEncaminhada.css" />

<script type="text/javascript" src="./js/relatorioQuantitativoEncaminhada.js"></script>
</head>
<!-- Definicoes Comuns -->
		...
		<div id="main_container" class="main_container container_16 clearfix">
			...
			<div class="box grid_16 tabs">
				<ul class="tab_header clearfix">
					<li><a href="#tabs-1"><fmt:message key="relatorioExecucaoSolicitacao.titulo.execucaoSolicitacao" /></a></li>
				</ul>
				...
				<div class="toggle_container">
					<div class="block" >
						<div id="parametros">
							<form name='form'
								action='${ctx}/pages/relatorioQuantitativoEncaminhada/relatorioQuantitativoEncaminhada'>
							...
							<div class="columns clearfix">
									...
									<div class="col_20">
										<fieldset style="height: 64px">
											<label><fmt:message key="citcorpore.comum.grupoaprovador" /></label>
											<div>
