...
<script>
    ...
    function excluirImagemUpload(path){
        if (confirm(i18n_message("citcorpore.comum.confirme.desejaexcluiranexo"))){
            window.location = '${ctx}/pages/uploadExcluirRequisicaoMudanca/uploadExcluirRequisicaoMudanca.load?path=' + path;
        }
    }
    ...
    function excluirAnexo(id, nomeArquivo){
        if(confirm(i18n_message("citcorpore.comum.confirme.exclusaoanexo"))){
            window.location = '${ctx}/pages/uploadExcluirRequisicaoMudanca/excluirAnexo.donameFile=' + nomeArquivo + '&id='+id;
        }
    }
    <%
