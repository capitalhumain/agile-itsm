...
<script type="text/javascript" src="./js/tipoServico.js"></script>
</head>
<body>
	<div id="wrapper">
		...
		<div id="main_container" class="main_container container_16 clearfix">
			...
			<div class="flat_area grid_16">
				<h2>
					<fmt:message key="tipoServico.tipoServico" />
				</h2>
			</div>
			<div class="box grid_16 tabs">
				<ul class="tab_header clearfix">
					<li><a href="#tabs-1"><fmt:message key="tipoServico.cadastroTipoServico" />
					</a></li>
					<li><a href="#tabs-2" class="round_top"><fmt:message key="tipoServico.pesquisaTipoServico" />
					</a></li>
				</ul>
				...
				<div class="toggle_container">
					<div id="tabs-1" class="block">
						<div class="section">
							<form name='form'
								action='${ctx}/pages/tipoServico/tipoServico'>
