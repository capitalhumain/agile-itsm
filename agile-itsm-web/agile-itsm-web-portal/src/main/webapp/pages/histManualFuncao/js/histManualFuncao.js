...
function gerarButtonVisualizaHistorico(row, obj) {
	row.cells[5].innerHTML += '<a href="#" class="btn-action glyphicons remove_2 btn-danger titulo" onclick="visualizarHistoricoVersao('+obj.idManualFuncao+')"><i></i></a>        ';
}
function visualizarHistoricoVersao(idManualFuncao) {
//	HTMLUtils.deleteRow('tblHistoricoVersoes', indice);
	alert(idManualFuncao);
}
...
function limparDados() {
	var arr = ["tblResponsabilidades", "tblCertificacoesRA", "tblCursosRA", "tblCertificacoesRF", "tblCursoRF", "tblCompetencias", "tblPerspectivaComportamental"];
	limparTabelas(arr);
}
