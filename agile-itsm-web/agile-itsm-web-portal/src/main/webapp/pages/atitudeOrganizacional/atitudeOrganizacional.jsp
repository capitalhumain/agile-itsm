	...
	<div id="wrapper">
		...
		<%if (iframe == null) {%>
			...
			<div class="flat_area grid_16">
				<h2>
					<fmt:message key="solicitacaoCargo.atitudesOrganizacional" />
				</h2>
			</div>
			<div class="box grid_16 tabs">
				<ul class="tab_header clearfix">
					<li><a href="#tabs-1"><fmt:message key="solicitacaoCargo.cadastroAtitudeOrganizacional" />
					</a></li>
					<li><a href="#tabs-2" class="round_top"><fmt:message key="solicitacaoCargo.pesquisaAtitudeOrganizacional" />
					</a></li>
				</ul>
				...
				<div class="toggle_container">
					<div id="tabs-1" class="block">
						...
						<div class="section">
							...
							<form id='form'
								  name='form'
								  action='${ctx}/pages/atitudeOrganizacional/atitudeOrganizacional'>
