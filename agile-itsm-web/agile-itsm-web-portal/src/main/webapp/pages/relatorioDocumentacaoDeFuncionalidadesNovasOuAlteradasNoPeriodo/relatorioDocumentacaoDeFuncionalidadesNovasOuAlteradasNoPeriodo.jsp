...
<link type="text/css" rel="stylesheet"
	...
	<link rel="stylesheet" type="text/css" href="./css/relatorioDocumentacaoDeFuncionalidadesNovasOuAlteradasNoPeriodo.css" />
</head>
...
<body>
					...
					<div class="innerLR">
						<div class="widget">
							<div class="widget-head">
								<h4 class="heading">
									<fmt:message key="relatorioDocumentacaoDeFuncionalidadesNovasOuAlteradasNoPeriodo.title" />
								</h4>
							</div>
							<div class="widget-body collapse in">
								<form name="form" id="form"action="${ctx}/pages/relatorioDocumentacaoDeFuncionalidadesNovasOuAlteradasNoPeriodo/relatorioDocumentacaoDeFuncionalidadesNovasOuAlteradasNoPeriodo.load">
	...
	<script type="text/javascript" src="./js/relatorioDocumentacaoDeFuncionalidadesNovasOuAlteradasNoPeriodo.js"></script>
</body>
</html>
