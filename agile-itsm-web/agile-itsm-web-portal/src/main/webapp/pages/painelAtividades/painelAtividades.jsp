...
<link type="text/css" rel="stylesheet" href="${ctx}/css/ui-lightness/jquery-ui-1.8.16.custom.css" />
<link type="text/css" rel="stylesheet" href="${ctx}/css/geral.css" />
<link type="text/css" rel="stylesheet" href="${ctx}/css/form.css" />
...
<script type="text/javascript" src="${ctx}/js/efeitos.js"></script>
...
<form action="" id="form_teste">
    <div id="wrap">
        <div id="header">
            <%@include file="${ctx}/include/menu2011/menuConfig.jsp"%>
