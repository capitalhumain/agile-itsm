...
<head>
	...
	<link rel="stylesheet" type="text/css" href="./css/relatorioQuantitativoProblema.css" />

	<script type="text/javascript" src="./js/relatorioQuantitativoProblema.js"></script>
</head>
	...
	<div id="wrapper">
		...
		<div id="main_container" class="main_container container_16 clearfix">
			...
			<div class="flat_area grid_16">
				<h2><fmt:message key="relatorioQuantitativoProblema.relatorioQuantitativoProblema"/></h2>
			</div>
			<div class="box grid_16 tabs">
				<ul class="tab_header clearfix">
					<li><a href="#tabs-1"><fmt:message key="relatorioQuantitativoProblema.relatorioQuantitativoProblema" /></a></li>
				</ul>
				<a href="#" class="toggle">&nbsp;</a>
				<div class="toggle_container">
					<div class="block" >
						<div id="parametros">
							<form name="form" action="${ctx}/pages/relatorioQuantitativoProblema/relatorioQuantitativoProblema">
